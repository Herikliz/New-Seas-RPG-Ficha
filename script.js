...
const akumasFixas = {
    ...
    Zoan: [
        ...
        "Neko Neko no Mi, Modelo: Tigre-de-BengalaBengala",
        "Rako Rako no Mi",
...
const shipData = {
    Bote: { hp: 3, gender: "m" },
    "Barco Pesqueiro": { hp: 5, gender: "m" },
    Escuna: { hp: 7, gender: "f" },
    Brigue: { hp: 8, gender: "m" },
    Caravela: { hp: 9, gender: "f" },
    Fragata: { hp: 10, gender: "f" },
    "Gran General": { hp: 12, gender: "m" },
    "C-15 Kenpachi": { hp: 5, gender: "m" },
    "Z-10 Perci": { hp: 7, gender: "m" },
    "B-47 Hajime": { hp: 10, gender: "m" },
    "T-33 Apollo": { hp: 10, gender: "m" },
    "K-55 Mereoleona": { hp: 15, gender: "m" },
    "A-1 Atlas": { hp: 20, gender: "m" },
    "5-01 Sparkle": { hp: 7, gender: "m" },
    "4-01 Dream": { hp: 10, gender: "m" },
    "3-01 Scream": { hp: 10, gender: "m" },
    "2-01 Liberty": { hp: 15, gender: "m" },
    "1-01 Hope": { hp: 20, gender: "m" },
    "Pérola Negra": { hp: null, gender: "m" },
    "Holandês Voador": { hp: null, gender: "m" },
    "Vingança da Rainha Ana": { hp: null, gender: "f" },
    "Silent Mary": { hp: null, gender: "f" },
    Pequod: { hp: null, gender: "m" },
};
...
const racas = {
    ...
    Mink: { v: 0.2, r: 0.15 },
    Oni: { f: 0.4, r: 0.4 },
    "Pernas Longas": { v: 0.3, f: 0.15 },
    "Povo do Céu: Birkan": { d: 0.25, v: 0.25 },
    "Povo do Céu: Shandia": { d: 0.25, v: 0.25 },
    "Povo do Céu: Skypieano": { d: 0.25, v: 0.25 },
    Sereiano: { d: 0.25, r: 0.15 },
    Tontatta: { v: 0.25, f: 0.2 },
    "Três-Olhos": { v: 0.15, r: 0.15, d: 0.15 },
    Tritão: { f: 0.25, r: 0.25 },
    Wotan: { f: 0.3, r: 0.25 },
};
const linhagens = {
    "Nenhuma": {},
...
const habilidadesExclusivasDict = {
    "Arte da Esgrima":
        "+10% em Destreza quando tiver 5.000 pontos (15% aos 10k, 20% aos 15k). A partir dos 5.000 pontos: -20% de gasto de Estamina.",
    "Batedor de Carteiras":
        "+15% em Destreza quando tiver 5.000 pontos (20% aos 10k, 25% aos 15k).",
    "Caminho do Atirador":
        "+5% em Destreza quando tiver 5.000 pontos (10% aos 10k, 15% aos 15k). +10% em Destreza ao atirar com armas de fogo (15% aos 10k, 20% aos 15k).",
    "Constituição Única": "+10% de Força e +15% de Resistência.",
    "Contração Muscular":
        "+10% de Força e Resistência quando tiver 5.000 pontos (20% aos 10k).",
    "Espírito Contagiante":
        "Aos 5k: Aliados e Usuário +5% Atributos, -10% Estamina. Aos 10k: +10% Atributos, Usuário +10% Resistência. Aos 15k: +15% Atributos, Usuário +10% Redução de Dano.",
    "Favoritismo Armista":
    ...
    "Golpe de Retorno":
        "Reflete a dor/dano para o oponente (3x/dia). 1º uso: Normal. 2º uso: -10% de Resistência. 3º uso: -20% de Resistência.",
    "O Escolhido":
        "+5% em todos os tipos de Haki aos 5.000 (10% aos 10k, 15% aos 20k).",
...
const patenteGender = {
    ...
    "Coordenador De Operações": {
        m: "Coordenador de Operações",
        f: "Coordenadora de Operações",
    },
    "Esquadrão de Combate": {
        m: "Esquadrão de Combate",
        f: "Esquadrão de Combate",
    },
    "Esquadrão de Operações": {
        m: "Esquadrão de Operações",
        f: "Esquadrão de Operações",
    },
    "Esquadrão de Inteligência": {
        m: "Esquadrão de Inteligência",
        f: "Esquadrão de Inteligência",
    },
    "Esquadrão de Defesa": {
        m: "Esquadrão de Defesa",
        f: "Esquadrão de Defesa",
    },
    "Comandante Tático de Combate": {
        m: "Comandante Tático de Combate",
        f: "Comandante Tática de Combate",
    },
    "Comandante Tático de Operações": {
        m: "Comandante Tático de Operações",
        f: "Comandante Tática de Operações",
    },
    "Comandante Tático de Inteligência": {
        m: "Comandante Tático de Inteligência",
        f: "Comandante Tática de Inteligência",
    },
    "Comandante Tático de Defesa": {
        m: "Comandante Tático de Defesa",
        f: "Comandante Tática de Defesa",
    },
    "Capitão Tático de Combate": {
        m: "Capitão Tático de Combate",
        f: "Capitã Tática de Combate",
    },
    "Capitão Tático de Operações": {
        m: "Capitão Tático de Operações",
        f: "Capitã Tática de Operações",
    },
    "Capitão Tático de Inteligência": {
        m: "Capitão Tático de Inteligência",
        f: "Capitã Tática de Inteligência",
    },
    "Capitão Tático de Defesa": {
...
const salarios = {
    ...
    "Esquadrão de Operações": 60000000,
    "Esquadrão de Inteligência": 60000000,
    "Esquadrão de Defesa": 60000000,
    "Comandante Tático de Combate": 80000000,
    "Comandante Tático de Operações": 80000000,
    "Comandante Tático de Inteligência": 80000000,
    "Comandante Tático de Defesa": 80000000,
    "Comandante Tática de Combate": 80000000,
    "Comandante Tática de Operações": 80000000,
    "Comandante Tática de Inteligência": 80000000,
    "Comandante Tática de Defesa": 80000000,
    "Capitão Tático de Combate": 100000000,
    "Capitão Tático de Operações": 100000000,
    "Capitão Tático de Inteligência": 100000000,
    "Capitão Tático de Defesa": 100000000,
    "Capitã Tática de Combate": 100000000,
...
function switchChar(pIdx, nIdx) {
    ...
    activeNpcIndex = nIdx;
    currentChar =
        nIdx === -1 ? charData.pcs[pIdx].pc : charData.pcs[pIdx].npcs[nIdx];
    renderTabs();
    updateUI();
    renderTecnicas();
    renderNpcsComuns();
...
async function deleteCurrentChar() {
    if (isReadOnly) {
        await customAlert(
            "Você está no modo de leitura. Não é possível apagar.",
        );
        return;
    }
    ...
    if (charData.password && charData.password.trim() !== "") {
        let pwd = await customPrompt(
            "Digite a senha da ficha para confirmar a exclusão:",
        );
        if (
        ...
        let pwd = await customPrompt(
            "A ficha não tem senha. Digite 'SIM' para confirmar a exclusão:",
        );
        if (pwd !== "SIM" && pwd !== "sim") {
            return;
        }
...
async function travarFichaCombate() {
    if (isReadOnly) {
        await customAlert(
            "Você está no modo de leitura. Não é possível travar a ficha.",
        );
        return;
    }

    let conf = await customPrompt(
        "Deseja criar uma cópia de sua ficha para usar no combate enquanto a ficha original continua evoluindo? Digite 'SIM' para confirmar:",
    );
    ...
    let baseName = (
        clonedPcObj.pc.name || `Personagem ${activePcIndex + 1}`
    ).trim();
    ...
    await customAlert(
        "Ficha travada com sucesso! A aba de combate congelada foi criada e selecionada.",
    );
}
...
window.dragEnter = function (event) {
    ...
    if (
        t.tagName === "BUTTON" &&
        (t.classList.contains("btn-tab") || t.classList.contains("btn-add"))
    ) {
...
window.dropOnTab = function (event, targetPIdx, targetNIdx) {
    ...
    let sP = parseInt(event.dataTransfer.getData("pIdx"));
    let sN = parseInt(event.dataTransfer.getData("nIdx"));
    ...
    if (sN === -1 && targetNIdx === -1) {
        ...
        let insertIdx = targetPIdx;
        if (sP < targetPIdx) insertIdx--;
        charData.pcs.splice(insertIdx, 0, rowToMove);
        activePcIndex = insertIdx;
        activeNpcIndex = -1;
        saveAndRenderDrag();
        return;
    }
    ...
    let charToMove;
    let rowWasRemoved = false;
    if (sN === -1) {
        charToMove = charData.pcs[sP].pc;
        if (charData.pcs[sP].npcs.length === 0) {
            charData.pcs.splice(sP, 1);
            rowWasRemoved = true;
        } else {
            let firstNpc = charData.pcs[sP].npcs.shift();
            firstNpc.isNPC = false;
            charData.pcs[sP].pc = firstNpc;
        }
    } else {
        charToMove = charData.pcs[sP].npcs.splice(sN, 1)[0];
    }
    ...
    if (targetNIdx === -1) {
        ...
        activePcIndex = targetPIdx;
        activeNpcIndex = -1;
    } else {
        if (sP === targetPIdx && sN !== -1 && sN < targetNIdx && !rowWasRemoved)
            targetNIdx--;
        charToMove.isNPC = true;
        charData.pcs[targetPIdx].npcs.splice(targetNIdx, 0, charToMove);
        activePcIndex = targetPIdx;
        activeNpcIndex = targetNIdx;
    }
    if (charData.pcs.length === 0) {
        charData.pcs.push({ pc: createEmptyChar(false), npcs: [] });
        activePcIndex = 0;
...
window.dropOnAddNpc = function (event, targetPIdx) {
    ...
    activePcIndex = targetPIdx;
    activeNpcIndex = charData.pcs[targetPIdx].npcs.length - 1;
    if (charData.pcs.length === 0) {
        charData.pcs.push({ pc: createEmptyChar(false), npcs: [] });
        activePcIndex = 0;
        activeNpcIndex = -1;
...
function setupSumButtons() {
    const inputs = document.querySelectorAll(
        "input[oninput*='formatAndSave'], input[oninput*='formatCurrency']",
    );
    inputs.forEach((inp) => {
        if (
            inp.parentNode.classList.contains("sum-wrapper") ||
            inp.classList.contains("no-sum")
        )
            return;
        ...
        btnMinus.style.cssText =
            "padding: 0 8px; margin: 0; font-size: 16px; font-weight: bold; border-color: var(--danger); color: var(--danger); cursor: pointer; border-radius: 4px; display: flex; align-items: center; justify-content: center;";
        ...
        btnMinus.onclick = async () => {
            ...
            if (val !== null && val.trim() !== "") {
                ...
                if (!isNaN(numToSub)) {
                    let currentVal =
                        parseInt(inp.value.replace(/\D/g, ""), 10) || 0;
        ...
        btnPlus.style.cssText =
            "padding: 0 8px; margin: 0; font-size: 16px; font-weight: bold; border-color: var(--success); color: var(--success); cursor: pointer; border-radius: 4px; display: flex; align-items: center; justify-content: center;";
        btnPlus.title = "Somar";
...
function saveData(force = false) {
    ...
    let isSheetEmpty = charData.pcs.every(
        (p) =>
            (p.pc.name || "").trim() === "" &&
            (!p.npcs || p.npcs.every((n) => (n.name || "").trim() === "")),
    );
        ...
        db.collection("fichas_op")
            ...
            .catch((error) => {
                document
                    .getElementById("db-status")
                    .classList.remove("syncing");
                document.getElementById("db-status").classList.remove("online");
            });
    }
}
...
function updateSaveMode(mode) {
    if (
        (currentDocId === "NPCS" || currentDocId === "NPCI") &&
        mode !== "manual"
    ) {
        customAlert(
    ...
    if (btnSave)
        btnSave.style.display = mode === "manual" ? "inline-block" : "none";
    if (mode === "auto") {
        document.getElementById("db-status").classList.remove("unsaved");
        let toast = document.getElementById("save-toast");
        if (toast && toast.textContent === "Salve as alterações!") {
...
async function managePassword() {
    if (currentDocId === "") {
        await customAlert(
            "Digite um ID na nuvem e puxe ou crie uma ficha primeiro!",
        );
        return;
    }
    if (currentDocId === "NPCS" || currentDocId === "NPCI") {
    ...
    if (isReadOnly) {
        await customAlert(
            "Você está no modo de leitura. Recarregue a ficha e insira a senha correta antes de tentar modificar a segurança.",
        );
        return;
    }

    if (charData.password && charData.password.trim() !== "") {
        let oldPass = await customPrompt(
            "Digite a senha atual para autorizar a mudança:",
        );
        if (
            ...
            if (newPass !== null) {
                ...
                await customAlert(
                    charData.password === ""
                        ? "A senha foi removida com sucesso!"
...
function toggleEditability() {
    const elements = document.querySelectorAll(
        ".container input:not(#info-salario):not(#info-patente), .container select, .container textarea, .container button",
    );
    let isNPC = currentChar.isNPC;
    elements.forEach((el) => {
        if (
            (el.innerText &&
                (el.innerText.includes("Copiar") ||
                    el.innerText.includes("Colapsar"))) ||
            el.id === "num-logs-copy"
        ) {
            el.disabled = false;
            return;
        ...
        let isNpcCBlocked =
            ...
            !hasNpcC &&
            (el.id === "btn-add-npc-c" ||
                (el.closest && el.closest("#npcs-comuns-container")));
        let isNpcEBlocked =
            isNPC &&
            !isSuperAdmin &&
            !hasNpcE &&
            (el.id === "btn-add-npc-e" ||
                (el.closest && el.closest("#npcs-especiais-container")));
        let isKuja =
    ...
    if (pwdBtn) {
        if (isReadOnly) {
            ...
            pwdBtn.innerText =
                charData.password && charData.password !== ""
                    ? "🔑 Redefinir Senha"
                    : "🔑 Definir Senha";
        }
    }
...
function runFallbackChecks() {
    ...
    if (saveModeEl) {
        ...
        if (btnSave)
            btnSave.style.display =
                charData.saveMode === "manual" ? "inline-block" : "none";
    }
    ...
    if (!charData.pcs) {
        ...
        if (charData.characters && charData.characters.length > 0) {
            ...
            mainPC.isNPC = false;
            let npcs = charData.characters
                .slice(1)
                .filter((c) => c.name || c.info.classe !== "Arqueólogo 1");
    ...
    charData.pcs.forEach((pObj) => {
        ...
        charsToCheck.forEach((c) => {
            ...
            if (typeof c.info.recompensaTravada === "string")
                c.info.recompensaTravada =
                    parseInt(c.info.recompensaTravada.replace(/\D/g, "")) || "";
            if (typeof c.info.berries === "string")
                c.info.berries =
                    parseInt(c.info.berries.replace(/\D/g, "")) || "";

            if (typeof c.info.boxTec === "undefined")
                c.info.boxTec = c.info.tecnicasColapsado || false;
            if (typeof c.info.boxLog === "undefined")
                c.info.boxLog = c.info.logsColapsado || false;
            if (typeof c.info.boxRes === "undefined")
                c.info.boxRes = c.info.resumoColapsado || false;
            ...
            const defInfo = {
                ...
                calcBuffFlat: "",
                calcBuffPct: "",
                calcBuffDanoFinalPct: "",
                calcUseAmi: "sim",
                amiPotBuff: "",
                calcUseHaki: "nao",
                calcUseHakiRei: "nao",
                sceneType: "Treino Padrão",
                sceneText: "",
                hpAtual: -1,
                boxIden: false,
                boxMec: false,
                ...
                hideTecEfeito: false,
                hiddenStyles: [],
                exaustaoCompleta: false,
                habilidadesExclusivas: [],
                habCaminhoAtiradorAtivo: false,
    ...
    if (activeNpcIndex >= charData.pcs[activePcIndex].npcs.length)
        activeNpcIndex = -1;
...
window.toggleAllBoxes = function (state) {
    ...
    document
        ...
        .forEach((box) => box.classList.remove("flipped"));
    saveData();
    updateUI();
};
...
window.toggleHiddenStyle = function (styleName, isChecked) {
    ...
    if (isChecked) {
        if (!currentChar.info.hiddenStyles.includes(styleName))
            currentChar.info.hiddenStyles.push(styleName);
    } else {
        currentChar.info.hiddenStyles = currentChar.info.hiddenStyles.filter(
            (s) => s !== styleName,
        );
    }
    saveData();
...
window.removeHabilidade = function (hab) {
    ...
    currentChar.info.habilidadesExclusivas =
        currentChar.info.habilidadesExclusivas.filter((h) => h !== hab);

    if (hab === "Caminho do Atirador")
        currentChar.info.habCaminhoAtiradorAtivo = false;
    if (hab === "Favoritismo Armista") {
        currentChar.info.habFavArmistaAtivo = "nenhum";
        currentChar.info.habFavArmistaAttr = "d";
    }
...
function addNpcComum() {
    ...
    currentChar.info.npcsComunsList.push({
        quantidade: "",
        raca: "Humano",
        pontos: "",
    });
...
window.addNavio = function () {
    ...
    currentChar.info.naviosList.push({
        tipo: "",
        nomeCustom: "",
        hpAtual: "",
        hpMax: "",
...
window.addArmaEquipada = function () {
    ...
    if (!currentChar.info.armasEquipadasList)
        currentChar.info.armasEquipadasList = [];
    currentChar.info.armasEquipadasList.push({
        nome: "",
        stat: "d",
        type: "pct",
        val: "",
...
window.updateArmaEquipada = function (idx, field, val) {
    ...
    if (field === "val") {
        ...
        let num = clean ? parseInt(clean, 10) : "";
        if (
            currentChar.info.armasEquipadasList[idx].type === "pct" &&
            num > 100
        )
            num = 100;
        ...
        let clean = val.replace(/\D/g, "");
        currentChar.info.armasEquipadasList[idx][field] = clean
            ? parseInt(clean, 10)
            : "";
    } else if (field === "type" && val === "pct") {
        let currentVal = currentChar.info.armasEquipadasList[idx].val;
        if (currentVal > 100)
            currentChar.info.armasEquipadasList[idx].val = 100;
    }
    saveData();
    updateUI();
    if (field !== "nome" && field !== "val" && field !== "hp")
        renderArmasEquipadas();
};
window.toggleArmaAtiva = function (idx) {
    if (isReadOnly) return;
    currentChar.info.armasEquipadasList[idx].ativo =
        !currentChar.info.armasEquipadasList[idx].ativo;
    saveData();
    updateUI();
    renderArmasEquipadas();
...
function renderNpcsComuns() {
    ...
    (currentChar.info.npcsComunsList || []).forEach((n, idx) => {
        ...
        let cQtd = String(n.quantidade || "").replace(/\D/g, "");
        let numQtd = parseInt(cQtd) || "";
        let cPts = String(n.pontos || "").replace(/\D/g, "");
...
function addNpcEspecial() {
    if (!currentChar.info.npcsEspeciaisList)
        currentChar.info.npcsEspeciaisList = [];
    let domCount = currentChar.info.npcsEspeciaisList.filter(
        (n) => n.origem === "Dominação",
    ).length;
    let extCount = currentChar.info.npcsEspeciaisList.filter(
        (n) => n.origem === "Extra-Narrada",
    ).length;
    let origem = "Evento";
    if (domCount < 3) origem = "Dominação";
    else if (extCount < 3) origem = "Extra-Narrada";
    currentChar.info.npcsEspeciaisList.push({
        nome: "",
        origem: origem,
        sexo: "Masculino",
        pontos: "",
...
function updateNpcEspecial(idx, field, val) {
    ...
    if (field === "origem") {
        let domCount = currentChar.info.npcsEspeciaisList.filter(
            (x) => x.origem === "Dominação",
        ).length;
        let extCount = currentChar.info.npcsEspeciaisList.filter(
            (x) => x.origem === "Extra-Narrada",
        ).length;
...
function renderNpcsEspeciais() {
    ...
    let elDom = document.getElementById("count-npc-dom");
    if (elDom) elDom.textContent = domCount;
    let elExt = document.getElementById("count-npc-ext");
    ...
    list.forEach((n, idx) => {
        ...
        let cHTML = (slotId, reqPts, prevSlots) => {
            if (pts < reqPts)
                return `<select disabled style="flex:1; font-size:10px;"><option>🔒 Req ${reqPts.toLocaleString("pt-BR")}</option></select>`;
            let counts = {};
            baseClassesList.forEach((c) => (counts[c] = 1));
            prevSlots.forEach((p) => {
                if (n[p]) {
                    let match = n[p].match(/(.+) (\d+)/);
                    if (match)
...
window.cloneTecnica = function (idx) {
    ...
    currentChar.tecnicasList.splice(
        idx + 1,
        0,
    ...
    if (val === "alfabetica") {
        ...
        [1, 2, 3, 4].forEach((n) => {
            ...
            if (st && st !== "Nenhum") {
                let dName =
                    st === "Freestyle"
                        ? i["freestyle" + n] && i["freestyle" + n].trim() !== ""
                            ? i["freestyle" + n]
                            : "Freestyle"
                        : st;
        ...
        currentChar.tecnicasList.sort((a, b) => {
            ...
            let stA = a.estilo
                ? availableStylesMap[a.estilo] || a.estilo
                : "Sem Estilo";
            let stB = b.estilo
                ? availableStylesMap[b.estilo] || b.estilo
                : "Sem Estilo";
...
function moveTecnica(idx, dir) {
    if (
        currentChar.info.ordemTecnicas === "alfabetica" ||
        currentChar.info.ordemTecnicas === "estilo"
    ) {
...
window.toggleAlcunhaCondicao = function (condName) {
    if (isReadOnly) return;
    if (!currentChar.info.alcunhaCondicoes)
        currentChar.info.alcunhaCondicoes = {};
    currentChar.info.alcunhaCondicoes[condName] =
        !currentChar.info.alcunhaCondicoes[condName];
    saveData();
    updateUI();
};
...
function editAlcunhaModal() {
    if (
        ...
        return;
    let ativa = currentChar.info.alcunhasList.find(
        (a) => a.nome === currentChar.info.alcunhaAtiva,
    );
    if (!ativa) return;
    ...
    if (ativa.buffs && ativa.buffs.length > 0) {
        ...
        document.getElementById("alcunha-buffs-container").style.display =
            "block";
    ...
    document.getElementById("btn-delete-alcunha").style.display =
        "inline-block";
    document.getElementById("modal-alcunha").style.display = "flex";
}
...
function saveAlcunha() {
    ...
    if (hasBuff) {
        document
            .querySelectorAll("#alcunha-buffs-list > div")
            .forEach((row) => {
...
window.handleRacaChange = async function (field, val) {
    if (isReadOnly) return;
    if (val === "Kuja") {
        let conf = await customConfirm(
            "Todas as Kuja são obrigatoriamente mulheres cisgênero. Você tem certeza que deseja escolher essa raça?",
        );
        if (!conf) {
            updateUI();
            return;
...
function updateField(category, field, value) {
    ...
    updateUI();
    if (
        field.startsWith("estilo") ||
        field.startsWith("freestyle") ||
        field === "raca" ||
        field === "raca2" ||
        field === "linhagem"
    )
...
function formatIdade(val) {
    ...
    if (i.raca === "Gigante") calcExp = baseExp * 4;
        ...
        ["Meio-Gigante", "Wotan", "Bucaneiro", "Lunariano", "Oni"].includes(
            i.raca,
        )
    )
        calcExp = baseExp * 2;
...
function strCalc(
    ...
    if (flat !== 0)
        parts.push(`${flat >= 0 ? "+" : ""}${flat.toLocaleString("pt-BR")}`);
    if (bonus !== 0)
        parts.push(`${bonus >= 0 ? "+" : ""}${(bonus * 100).toFixed(0)}%`);
    ...
    if (itemFlat !== 0)
        activeStr += `${itemFlat >= 0 ? "+" : ""}${itemFlat.toLocaleString("pt-BR")}`;
    if (itemBonus !== 0)
        activeStr += `${itemBonus >= 0 ? "+" : ""}${(itemBonus * 100).toFixed(0)}%`;
...
function toggleLayout() {
    charData.layoutMode =
        charData.layoutMode === "vertical" ? "desktop" : "vertical";
    updateUI();
    saveData();
}
...
function updateUI() {
    ...
    if (isNPC)
        rHtml += `<option value="Outra" ${i.raca === "Outra" ? "selected" : ""}>Outra...</option>`;
    for (let r in racas) {
        if (i.linhagem === "Charlotte" && noCharlotteRaces.includes(r))
            continue;
    ...
    if (i.linhagem === "Charlotte") {
        ...
        if (isNPC)
            r2Html += `<option value="Outra" ${i.raca2 === "Outra" ? "selected" : ""}>Outra...</option>`;
        for (let r in racas) {
        ...
        if (i.linhagem === "Charlotte") {
            ...
            let buildOpts = (racaName, suffix = "") => {
                ...
                if (racaName === "Humano" || racaName === "Kuja") {
                    for (let s in nomes)
                        html += `<option value="${s}">${nomes[s]} (+${racaName === "Kuja" && (s === "f" || s === "d") ? "30" : "20"}%)</option>`;
            ...
            if (sC1) {
                ...
                if (
                    Array.from(sC1.options).some((o) => o.value === i.selCharR1)
                )
                    sC1.value = i.selCharR1;
                else {
                    sC1.value = "";
                    i.selCharR1 = "";
                }
            ...
            if (sC2) {
                ...
                if (
                    Array.from(sC2.options).some((o) => o.value === i.selCharR2)
                )
                    sC2.value = i.selCharR2;
                else {
                    sC2.value = "";
                    i.selCharR2 = "";
                }
    ...
    if (pcNameEl && pcNameEl.value !== currentChar.name)
        pcNameEl.value = currentChar.name || "";
    ...
    let elAliados = document.getElementById("info-aliadosEspiritoContagiante");
    if (elAliados) elAliados.value = i.aliadosEspiritoContagiante || 0;
    let chkHideHist = document.getElementById("info-hideHistoria");
    if (chkHideHist) chkHideHist.checked = i.hideHistoria || false;
    let chkHidePers = document.getElementById("hide-personality");
    if (chkHidePers) chkHidePers.checked = i.hidePersonality || false;
    let chkHideSexo = document.getElementById("info-hideSexo");
    if (chkHideSexo) chkHideSexo.checked = i.hideSexo || false;
    let chkHideGenero = document.getElementById("info-hideGenero");
    if (chkHideGenero) chkHideGenero.checked = i.hideGenero || false;
    let chkExaustao = document.getElementById("info-exaustaoCompleta");
    if (chkExaustao) chkExaustao.checked = i.exaustaoCompleta || false;

    let chkHideTecNome = document.getElementById("info-hideTecNome");
    if (chkHideTecNome) chkHideTecNome.checked = i.hideTecNome || false;
    let chkHideTecDesc = document.getElementById("info-hideTecDesc");
    if (chkHideTecDesc) chkHideTecDesc.checked = i.hideTecDesc || false;
    let chkHideTecEfeito = document.getElementById("info-hideTecEfeito");
    if (chkHideTecEfeito) chkHideTecEfeito.checked = i.hideTecEfeito || false;
    let chkHideNaoTreinadas = document.getElementById("info-hideNaoTreinadas");
    if (chkHideNaoTreinadas)
        chkHideNaoTreinadas.checked = i.hideNaoTreinadas || false;
    let chkShowApenasNaoTreinadas = document.getElementById(
        "info-showApenasNaoTreinadas",
    );
    if (chkShowApenasNaoTreinadas)
        chkShowApenasNaoTreinadas.checked = i.showApenasNaoTreinadas || false;
    ...
    if (hideStylesContainer) {
        ...
        if (
            ...
            availableStylesToHide.push(i.akumaNome);
        [1, 2, 3, 4].forEach((n) => {
            let st = i["estilo" + n];
            if (st && st !== "Nenhum") {
                let dName =
    ...
    if (calcQuemAtacaEl && calcQuemAtacaEl.value !== i.calcQuemAtaca)
        calcQuemAtacaEl.value = i.calcQuemAtaca || "eu";

    let calcAttrEl = document.getElementById("info-calcUseAttr");
    let fmtCalcAttr = i.calcUseAttr
        ? i.calcUseAttr.toLocaleString("pt-BR")
        : "";
    if (calcAttrEl && calcAttrEl.value !== fmtCalcAttr)
        calcAttrEl.value = fmtCalcAttr;

    let calcResEl = document.getElementById("info-calcInimigoRes");
    let fmtCalcRes = i.calcInimigoRes
        ? i.calcInimigoRes.toLocaleString("pt-BR")
        : "";
    if (calcResEl && calcResEl.value !== fmtCalcRes)
        calcResEl.value = fmtCalcRes;

    let calcResIgnEl = document.getElementById("info-calcResIgnorada");
    let fmtCalcResIgn = i.calcResIgnorada
        ? i.calcResIgnorada.toLocaleString("pt-BR")
        : "";
    if (calcResIgnEl && calcResIgnEl.value !== fmtCalcResIgn)
        calcResIgnEl.value = fmtCalcResIgn;

    let calcDanoIgnEl = document.getElementById("info-calcDanoIgnorado");
    let fmtCalcDanoIgn = i.calcDanoIgnorado
        ? i.calcDanoIgnorado.toLocaleString("pt-BR")
        : "";
    if (calcDanoIgnEl && calcDanoIgnEl.value !== fmtCalcDanoIgn)
        calcDanoIgnEl.value = fmtCalcDanoIgn;

    let calcDanoAmiIgnEl = document.getElementById("info-calcDanoAmiIgnorado");
    let fmtCalcDanoAmiIgn = i.calcDanoAmiIgnorado
        ? i.calcDanoAmiIgnorado.toLocaleString("pt-BR")
        : "";
    if (calcDanoAmiIgnEl && calcDanoAmiIgnEl.value !== fmtCalcDanoAmiIgn)
        calcDanoAmiIgnEl.value = fmtCalcDanoAmiIgn;

    let calcBuffFlatEl = document.getElementById("info-calcBuffFlat");
    let fmtCalcBuffFlat = i.calcBuffFlat
        ? i.calcBuffFlat.toLocaleString("pt-BR")
        : "";
    if (calcBuffFlatEl && calcBuffFlatEl.value !== fmtCalcBuffFlat)
        calcBuffFlatEl.value = fmtCalcBuffFlat;

    let calcBuffPctEl = document.getElementById("info-calcBuffPct");
    let fmtCalcBuffPct = i.calcBuffPct
        ? i.calcBuffPct.toLocaleString("pt-BR")
        : "";
    if (calcBuffPctEl && calcBuffPctEl.value !== fmtCalcBuffPct)
        calcBuffPctEl.value = fmtCalcBuffPct;

    let calcBuffDanoFinalPctEl = document.getElementById(
        "info-calcBuffDanoFinalPct",
    );
    let fmtCalcBuffDanoFinalPct = i.calcBuffDanoFinalPct
        ? i.calcBuffDanoFinalPct.toLocaleString("pt-BR")
        : "";
    if (
        calcBuffDanoFinalPctEl &&
        calcBuffDanoFinalPctEl.value !== fmtCalcBuffDanoFinalPct
    )
        calcBuffDanoFinalPctEl.value = fmtCalcBuffDanoFinalPct;

    let amiPotBuffEl = document.getElementById("info-amiPotBuff");
    let fmtAmiPotBuff = i.amiPotBuff
        ? i.amiPotBuff.toLocaleString("pt-BR")
        : "";
    if (amiPotBuffEl && amiPotBuffEl.value !== fmtAmiPotBuff)
        amiPotBuffEl.value = fmtAmiPotBuff;

    let amiVelBuffEl = document.getElementById("info-amiVelBuff");
    let fmtAmiVelBuff = i.amiVelBuff
        ? i.amiVelBuff.toLocaleString("pt-BR")
        : "";
    if (amiVelBuffEl && amiVelBuffEl.value !== fmtAmiVelBuff)
        amiVelBuffEl.value = fmtAmiVelBuff;
    ...
    if (amiResPctEl && amiResPctEl.value !== fmtAmiResPct)
        amiResPctEl.value = fmtAmiResPct;

    let estVelEl = document.getElementById("info-estaminaVelocidade");
    let fmtEstVel = i.estaminaVelocidade
        ? i.estaminaVelocidade.toLocaleString("pt-BR")
        : "";
    if (estVelEl && estVelEl.value !== fmtEstVel) estVelEl.value = fmtEstVel;

    let estDanoEl = document.getElementById("info-estaminaDano");
    let fmtEstDano = i.estaminaDano
        ? i.estaminaDano.toLocaleString("pt-BR")
        : "";
    if (estDanoEl && estDanoEl.value !== fmtEstDano)
        estDanoEl.value = fmtEstDano;

    let estBuffPctEl = document.getElementById("info-estaminaBuffPct");
    let fmtEstBuffPct = i.estaminaBuffPct
        ? i.estaminaBuffPct.toLocaleString("pt-BR")
        : "";
    if (estBuffPctEl && estBuffPctEl.value !== fmtEstBuffPct)
        estBuffPctEl.value = fmtEstBuffPct;
    ...
    let fmtRecTrav = i.recompensaTravada
        ? i.recompensaTravada.toLocaleString("pt-BR")
        : "";
    if (recTravEl && recTravEl.value !== fmtRecTrav)
        recTravEl.value = fmtRecTrav;

    let elTreinos = document.getElementById("info-treinosAcumulados");
    let fmtTreinos = i.treinosAcumulados
        ? i.treinosAcumulados.toLocaleString("pt-BR")
        : "";
    if (elTreinos && elTreinos.value !== fmtTreinos)
        ...
        finalHR = 0;
    {
        ...
        if (
            tempLn !== "Nenhuma" &&
            linhagens[tempLn] &&
            linhagens[tempLn].req &&
            !linhagens[tempLn].req.includes(tempRc) &&
        ...
        if (tempLn !== "Charlotte") {
            if (racas[tempRc]) {
                tBonus.d += racas[tempRc].d || 0;
                tBonus.f += racas[tempRc].f || 0;
            ...
            let appChar = (rName, selVal, suffix = "") => {
                if (racas[rName]) {
                    for (let s in racas[rName]) {
                        if (racas[rName][s] < 0 && tBonus[s] !== undefined)
                ...
                if (selVal && tBonus[selVal] !== undefined) {
                    if (rName === "Humano") tBonus[selVal] += 0.2;
                        ...
                        tBonus[selVal] +=
                            selVal === "f" || selVal === "d" ? 0.3 : 0.2;
                    else if (racas[rName] && racas[rName][selVal] > 0)
                        tBonus[selVal] += racas[rName][selVal];
                }
            };
            appChar(tempRc, i.selCharR1);
            appChar(tempRc2, i.selCharR2, "2");
        }
        if (linhagens[tempLn]) {
            tBonus.d += linhagens[tempLn].d || 0;
            tBonus.f += linhagens[tempLn].f || 0;
            tBonus.r += linhagens[tempLn].r || 0;
            tBonus.v += linhagens[tempLn].v || 0;
            tBonus.esp += linhagens[tempLn].esp || 0;
            tBonus.ha += linhagens[tempLn].ha || 0;
            tBonus.ho += linhagens[tempLn].ho || 0;
            tBonus.hr += linhagens[tempLn].hr || 0;
            if (tempLn === "Barnum") {
                tBonus[i.selLinDF] += 0.1;
                tBonus[i.selLinRV] += 0.2;
            } else if (tempLn === "D.") {
                tBonus[i.selLin4] += 0.25;
            } else if (tempLn === "Gan") {
                tBonus[i.selLinDF] += 0.2;
            } else if (tempLn === "Kong") {
                tBonus[i.selLin4] += 0.2;
            } else if (tempLn === "Silvers") {
                tBonus[i.selLin4] += 0.15;
            } else if (tempLn === "Nico") {
                tBonus[i.selLinDF] += 0.1;
                tBonus[i.selLinRV] += 0.05;
            }
        }
        let habs = i.habilidadesExclusivas || [];
        let hHas = (hab) => habs.includes(hab);
        if (hHas("Arte da Esgrima")) {
            if (totalBase >= 15000) tBonus.d += 0.2;
            else if (totalBase >= 10000) tBonus.d += 0.15;
            else if (totalBase >= 5000) tBonus.d += 0.1;
        }
        if (hHas("Batedor de Carteiras")) {
            if (totalBase >= 15000) tBonus.d += 0.25;
            else if (totalBase >= 10000) tBonus.d += 0.2;
            else if (totalBase >= 5000) tBonus.d += 0.15;
        }
        if (hHas("Caminho do Atirador")) {
            if (totalBase >= 15000) tBonus.d += 0.15;
            else if (totalBase >= 10000) tBonus.d += 0.1;
            else if (totalBase >= 5000) tBonus.d += 0.05;
            if (i.habCaminhoAtiradorAtivo) {
                if (totalBase >= 15000) tBonus.d += 0.2;
                else if (totalBase >= 10000) tBonus.d += 0.15;
                else if (totalBase >= 5000) tBonus.d += 0.1;
            }
        }
        if (hHas("Constituição Única")) {
            tBonus.f += 0.1;
            tBonus.r += 0.15;
        }
        if (hHas("Contração Muscular")) {
            if (totalBase >= 10000) {
                tBonus.f += 0.2;
                tBonus.r += 0.2;
        ...
        if (hHas("Flexibilidade")) {
            if (totalBase >= 10000) tBonus.v += 0.2;
            else if (totalBase >= 5000) tBonus.v += 0.1;
        }
        if (hHas("Fúria Ardente")) {
            let fA = i.habFuriaArdenteAttr || "f";
            if (totalBase >= 15000) tBonus[fA] += 0.15;
            else if (totalBase >= 10000) tBonus[fA] += 0.1;
            else if (totalBase >= 5000) tBonus[fA] += 0.05;
        }
        if (hHas("O Escolhido")) {
            if (totalBase >= 20000) {
                tBonus.ha += 0.15;
        ...
        if (tempLn === "Beckman" && i.linhagemBeckmanArma) {
            tBonus.v += 0.05;
        }
        if (hHas("Golpe de Retorno")) {
            let usos = i.habRetornoUso || 1;
            if (usos === 2) tBonus.r -= 0.1;
            else if (usos === 3) tBonus.r -= 0.2;
        }
        ...
        totalFinal =
            Math.round((D + tFlat.d) * (1 + tBonus.d)) +
            Math.round((F + tFlat.f) * (1 + tBonus.f)) +
            Math.round((R + tFlat.r) * (1 + tBonus.r)) +
            Math.round((V + tFlat.v) * (1 + tBonus.v));
        finalHA = Math.round(
            ((currentChar.substats.hArm || 0) + tFlat.ha) * (1 + tBonus.ha),
        );
        finalHO = Math.round(
            ((currentChar.substats.hObs || 0) + tFlat.ho) * (1 + tBonus.ho),
        );
        finalHR = Math.round(
            ((currentChar.substats.hRei || 0) + tFlat.hr) * (1 + tBonus.hr),
        );
    }
    ...
    if (orgTipo === "Pirata" || orgTipo === "Caçador de Recompensa") {
        ...
        if (labelTripulacao)
            labelTripulacao.textContent =
                orgTipo === "Pirata" ? "Nome da Tripulação" : "Nome do Grupo";
        let boxPirataStatus = document.getElementById("box-pirataStatus");
        if (boxPirataStatus)
            boxPirataStatus.style.display =
                orgTipo === "Pirata" ? "block" : "none";
        let boxRecTravada = document.getElementById("box-recompensaTravada");
        if (boxRecTravada)
            boxRecTravada.style.display =
                orgTipo === "Pirata" && i.pirataStatus === "Shichibukai"
                    ? "block"
                    : "none";
        i.patente = "";
        i.salario = "";
        ...
        if (
            racasDesvantagem.includes(i.raca) ||
            racasDesvantagem.includes(i.raca2) ||
            i.linhagem === "D."
        )
            modifier = 1.1;

        if (orgTipo === "Marinha" && (!i.patente || i.patente === ""))
            i.patente = "Aprendiz";
        if (orgTipo === "Governo Mundial" && (!i.patente || i.patente === ""))
            i.patente = "Agente Judicial";
        if (
            orgTipo === "Vanguarda Popular Revolucionária" &&
            (!i.patente || i.patente === "")
        )
            i.patente = "Iniciado";
        ...
        if (orgTipo === "Marinha") {
            if (
                i.linhagem === "Tenryūbito: Família Donquixote" ||
                i.linhagem === "Tenryūbito: Família Figarland" ||
                i.linhagem === "Sakazuki" ||
                i.linhagem === "Kong" ||
                i.linhagem === "Nefertari"
            )
                modifier = 0.9;
        ...
        if (orgTipo === "Vanguarda Popular Revolucionária") {
            if (i.patente.startsWith("Esquadrão de "))
                baseCurrentPatente = "Esquadrão";
            else if (i.patente.startsWith("Comandante Tático de "))
                baseCurrentPatente = "Comandante Tático";
        ...
        if (nextRank) {
            if (orgTipo === "Marinha") {
                let reqs = {
                    ...
                    Capitão: 15000,
                    Comodoro: 20000,
                    "Contra-Almirante": 25000,
                    "Vice-Almirante": 30000,
                    Almirante: 45000,
                    "Almirante-de-Frota": 50000,
                };
                ptsReq = reqs[nextRank] * modifier;
                if (nextRank === "Vice-Almirante")
                    meritReq =
                        modifier === 0.9 ? 8 : modifier === 1.1 ? 12 : 10;
                ...
                let reqs = {
                    Operador: 1000,
                    Infiltrador: 2500,
                    "Soldado Revolucionário": 5000,
                    "Coordenador De Operações": 10000,
                    Esquadrão: 15000,
                    "Comandante Tático": 20000,
                    "Capitão Tático": 25000,
                    Pilar: 30000,
                    "Vice-Líder": 30000,
                    Eixo: 30000,
                };
        ...
        let baseSalario =
            typeof salarios[i.patente] !== "undefined"
                ? salarios[i.patente]
                : null;
        if (baseSalario !== null) {
    ...
    if (totalBaseDisplay) {
        ...
        totalBaseDisplay.style.color =
            totalBase > 1000 ? "var(--warning)" : "var(--info)";
        totalBaseDisplay.style.borderColor =
            totalBase > 1000 ? "var(--warning)" : "var(--info)";
    }
    ...
    if (avisoBase) {
        avisoBase.style.display = displayAviso;
        avisoBase.textContent = textAviso;
    }

    let isNico = i.linhagem === "Nico",
        isTom = i.linhagem === "Tom",
        isVega = i.linhagem === "Vega";
    ...
    if (isSp) {
        ...
        if (i.classe && el1.querySelector(`option[value="${i.classe}"]`))
            el1.value = i.classe;
        else {
            el1.value = "";
        }
    ...
    if (isSp) {
        ...
        classSlots = [
            ...
            { id: "classe3", req: 10000, prev: [i.classe, i.classe2] },
            {
                id: "classe4",
                req: 20000,
                prev: [i.classe, i.classe2, i.classe3],
            },
            {
                id: "classe5",
                req: 35000,
                prev: [i.classe, i.classe2, i.classe3, i.classe4],
            },
        ];
    }
    ...
    classSlots.forEach((slot) => {
        ...
        if (isSuperAdmin || totalFinal >= slot.req || hasClassAssigned) {
            ...
            if (
                Array.from(el.options).some((o) => o.value === currentVal) &&
                currentVal !== ""
            ) {
                el.value = currentVal;
            } else {
    ...
    for (let l in linhagens) {
        if (
            l !== "Nenhuma" &&
            (!linhagens[l].req ||
                linhagens[l].req.includes(i.raca) ||
                (isNPC && i.raca === "Outra"))
        ) {
            htmlLin += `<option value="${l}">${l}</option>`;
        }
    }
    if (selLin.innerHTML !== htmlLin) selLin.innerHTML = htmlLin;
    if (Array.from(selLin.options).some((o) => o.value === currentLin)) {
        selLin.value = currentLin;
    } else {
        i.linhagem = "";
        selLin.value = "";
        currentLin = "";
    ...
    let rc = i.raca,
        rc2 = i.raca2,
        ln = currentLin;
    let isLinhagemVisible =
        rc && !["Bucaneiro", "Oni", "Lunariano"].includes(rc);
    document.getElementById("container-linhagem").style.display =
        isLinhagemVisible ? "block" : "none";
    ...
    document.getElementById("box-extraLin").style.display = showExtraLin
        ? "flex"
        : "none";
    document.getElementById("info-selLinDF").style.display = [
        "Barnum",
        "Gan",
        "Nico",
    ].includes(ln)
        ? "block"
        : "none";
    document.getElementById("info-selLinRV").style.display = [
        "Barnum",
        "Nico",
    ].includes(ln)
        ? "block"
        : "none";
    document.getElementById("info-selLin4").style.display = [
        "D.",
        "Kong",
        "Silvers",
    ].includes(ln)
        ? "block"
        : "none";
    document.getElementById("info-selLinEspAmi").style.display = [
        "D.",
    ].includes(ln)
        ? "block"
        : "none";
    ...
    if (elEst1) {
        ...
        allowedEstilo1.forEach((e) => {
            ...
            let disabled =
                ...
                e !== "Nenhum" &&
                e !== i.estilo1 &&
                [i.estilo2, i.estilo3, i.estilo4].includes(e)
                    ? "disabled"
                    : "";
    ...
    document.getElementById("info-estilo3").disabled =
        (!isSuperAdmin &&
            totalFinal < 5000 &&
            (!i.estilo3 || i.estilo3 === "Nenhum" || i.estilo3 === "")) ||
        isReadOnly;
    document.getElementById("info-estilo4").disabled =
        (!isSuperAdmin &&
            totalFinal < 10000 &&
            (!i.estilo4 || i.estilo4 === "Nenhum" || i.estilo4 === "")) ||
        isReadOnly;

    [1, 2, 3, 4].forEach((n) => {
        let elFree = document.getElementById("info-freestyle" + n);
        if (elFree) {
            elFree.style.display =
                i["estilo" + n] === "Freestyle" ? "block" : "none";
    ...
    if (isSuperAdmin || totalFinal >= reqEsp || hasEspPoints) {
        ...
        espEl.disabled = true;
        espEl.placeholder = `🔒 Requer ${reqEsp.toLocaleString("pt-BR")}`;
        currentChar.stats.esp = 0;
        currentChar.substats.hArm = 0;
        currentChar.substats.hObs = 0;
        currentChar.substats.hRei = 0;
        document.getElementById("box-haki").style.display = "none";
    }

    let amiEl = document.getElementById("stat-ami");
    let temFruta =
        i.akumaNome && i.akumaNome !== "nenhuma" && i.akumaNome !== "";

    let isInimigoCalc = i.calcQuemAtaca === "inimigo";

    let boxCalcAmi = document.getElementById("box-calcUseAmi");
    if (boxCalcAmi) {
        boxCalcAmi.style.display =
            isInimigoCalc || (temFruta && ln !== "Silvers") ? "block" : "none";
        let lblAmi = document.getElementById("label-calcUseAmi");
        if (lblAmi)
            lblAmi.textContent = isInimigoCalc ? "Dano Akuma" : "Somar Akuma?";
    ...
    if (elHakiManual)
        elHakiManual.style.display = isInimigoCalc ? "block" : "none";
    let lblHaki = document.getElementById("label-calcUseHaki");
    if (lblHaki)
        lblHaki.textContent = isInimigoCalc
            ? "Dano Armamento"
            : "Somar Armamento?";
    let elCalcUseHaki = document.getElementById("info-calcUseHaki");
    if (elCalcUseHaki)
        elCalcUseHaki.style.display = isInimigoCalc ? "none" : "block";

    let elHakiReiManual = document.getElementById("info-calcHakiReiManual");
    if (elHakiReiManual)
        elHakiReiManual.style.display = isInimigoCalc ? "block" : "none";
    let lblHakiRei = document.getElementById("label-calcUseHakiRei");
    if (lblHakiRei)
        lblHakiRei.textContent = isInimigoCalc ? "Dano Rei" : "Somar Rei?";
    let elCalcUseHakiRei = document.getElementById("info-calcUseHakiRei");
    if (elCalcUseHakiRei)
        elCalcUseHakiRei.style.display = isInimigoCalc ? "none" : "block";

    let fmtAmiMan = i.calcAmiManual
        ? i.calcAmiManual.toLocaleString("pt-BR")
        : "";
    if (
        document.getElementById("info-calcAmiManual") &&
        document.getElementById("info-calcAmiManual").value !== fmtAmiMan
    )
        document.getElementById("info-calcAmiManual").value = fmtAmiMan;
    let fmtHakiMan = i.calcHakiManual
        ? i.calcHakiManual.toLocaleString("pt-BR")
        : "";
    if (elHakiManual && elHakiManual.value !== fmtHakiMan)
        elHakiManual.value = fmtHakiMan;
    let fmtHakiReiMan = i.calcHakiReiManual
        ? i.calcHakiReiManual.toLocaleString("pt-BR")
        : "";
    if (elHakiReiManual && elHakiReiManual.value !== fmtHakiReiMan)
        elHakiReiManual.value = fmtHakiReiMan;

    let boxAmiPotBuff = document.getElementById("box-amiPotBuff");
    if (boxAmiPotBuff)
        boxAmiPotBuff.style.display =
            temFruta && ln !== "Silvers" && i.hasAmiPot ? "flex" : "none";
    let boxAmiVelBuff = document.getElementById("box-amiVelBuff");
    if (boxAmiVelBuff)
        boxAmiVelBuff.style.display =
            temFruta && ln !== "Silvers" && i.hasAmiVel ? "flex" : "none";

    let containerBoxAmi = document.getElementById("container-boxAmi");
    if (containerBoxAmi)
        containerBoxAmi.style.display = ln === "Silvers" ? "none" : "flex";

    let hasAmiPoints = currentChar.stats.ami > 0;
    if (!isSuperAdmin && ln === "Silvers" && !hasAmiPoints) {
        amiEl.disabled = true;
        amiEl.placeholder = "🔒 Indisponível";
        currentChar.stats.ami = 0;
        currentChar.substats.amiAlc = 0;
        currentChar.substats.amiDur = 0;
        currentChar.substats.amiPot = 0;
        currentChar.substats.amiVel = 0;
    } else if (!isSuperAdmin && !temFruta && !hasAmiPoints) {
        amiEl.disabled = true;
        amiEl.placeholder = "🔒 Requer Fruta";
        currentChar.stats.ami = 0;
        currentChar.substats.amiAlc = 0;
        currentChar.substats.amiDur = 0;
        currentChar.substats.amiPot = 0;
    ...
    if (i.alcunhasList && i.alcunhaAtiva) {
        ...
        if (ativa && ativa.buffs) {
            ativa.buffs.forEach((b) => {
                ...
                targets.forEach((t) => {
                    if (b.type === "pct") {
                        if (typeof bonus[t] !== "undefined")
                            bonus[t] += b.val / 100;
                    } else {
                        if (typeof flatBonus[t] !== "undefined")
                            flatBonus[t] += b.val;
                    }
                });
            });
    ...
    if (i.hasAmiAlc) baseAmiStatsForZoan++;
    if (i.hasAmiDur) baseAmiStatsForZoan++;
    if (i.hasAmiPot) baseAmiStatsForZoan++;
    if (i.hasAmiVel) baseAmiStatsForZoan++;
    let currentBasePointsForZoan =
        (currentChar.substats.amiAlc || 0) +
        (currentChar.substats.amiDur || 0) +
        (currentChar.substats.amiPot || 0) +
        (currentChar.substats.amiVel || 0);
    let controlePctForZoan =
        baseAmiStatsForZoan > 0
            ? parseFloat(
                  (
                      (currentBasePointsForZoan /
                          (baseAmiStatsForZoan * 10000)) *
                      100
                  ).toFixed(2),
              )
            : 0;
    ...
    let isZoan =
        ...
        ((akumasFixas["Zoan"] && akumasFixas["Zoan"].includes(i.akumaNome)) ||
            (akumasFixas["Zoan Ancestral"] &&
                akumasFixas["Zoan Ancestral"].includes(i.akumaNome)) ||
            (akumasFixas["Zoan Mítica"] &&
                akumasFixas["Zoan Mítica"].includes(i.akumaNome)));
    ...
    if (elZoanBox) {
        if (hasZoanBox) {
            ...
            if (isParameciaEspecial) {
                ...
                document.getElementById("btn-forma-comum").style.borderColor =
                    i.zoanForma === "Comum" ? "var(--success)" : "#444";
                document.getElementById("btn-forma-comum").style.color =
                    i.zoanForma === "Comum" ? "var(--success)" : "inherit";
                document.getElementById(
                    "btn-forma-instavel",
                ).style.borderColor =
                    i.zoanForma === "Instável" ? "var(--success)" : "#444";
                document.getElementById("btn-forma-instavel").style.color =
                    i.zoanForma === "Instável" ? "var(--success)" : "inherit";

                let btnHibrida = document.getElementById("btn-forma-hibrida");
                if (controlePctForZoan < 20 && !isSuperAdmin) {
                    btnHibrida.disabled = true;
                    if (i.zoanForma === "Híbrida") i.zoanForma = "Comum";
                } else {
                    btnHibrida.disabled = false;
                }
                btnHibrida.style.borderColor =
                    i.zoanForma === "Híbrida" ? "var(--success)" : "#444";
                btnHibrida.style.color =
                    i.zoanForma === "Híbrida" ? "var(--success)" : "inherit";

                let btnCompleta = document.getElementById("btn-forma-completa");
                if (controlePctForZoan < 60 && !isSuperAdmin) {
                    btnCompleta.disabled = true;
                    if (i.zoanForma === "Completa") i.zoanForma = "Comum";
                } else {
                    btnCompleta.disabled = false;
                }
                btnCompleta.style.borderColor =
                    i.zoanForma === "Completa" ? "var(--success)" : "#444";
                btnCompleta.style.color =
                    i.zoanForma === "Completa" ? "var(--success)" : "inherit";
            }
        } else {
        ...
        i.armasEquipadasList.forEach((a) => {
            if (a.ativo && a.stat) {
                ...
                if (val !== 0) {
                    ...
                    targets.forEach((t) => {
                        if (a.type === "pct") {
                            if (typeof itemBonus[t] !== "undefined")
                                itemBonus[t] += val / 100;
                        } else {
                            if (typeof itemFlat[t] !== "undefined")
                                itemFlat[t] += val;
                        }
                    });
                }
    ...
    for (let k in itemBonus) {
        if (itemBonus[k] > 1.0) itemBonus[k] = 1.0;
    }

    itemBonus.amiAlc += itemBonus.ami;
    itemBonus.amiDur += itemBonus.ami;
    itemBonus.amiPot += itemBonus.ami;
    itemBonus.amiVel += itemBonus.ami;
    itemBonus.amiDesp += itemBonus.ami;
    itemBonus.ami = 0;
    itemFlat.amiAlc += itemFlat.ami;
    itemFlat.amiDur += itemFlat.ami;
    itemFlat.amiPot += itemFlat.ami;
    itemFlat.amiVel += itemFlat.ami;
    itemFlat.amiDesp += itemFlat.ami;
    itemFlat.ami = 0;
        ...
        let applyCharlotteBuff = (rName, selVal, suffix = "") => {
            ...
            if (selVal) {
                if (rName === "Humano") bonus[selVal] += 0.2;
                    ...
                    bonus[selVal] += racas[rName][selVal];
            }
        };
    ...
    if (
        ...
        bonus.d += linhagens[ln].d || 0;
        bonus.f += linhagens[ln].f || 0;
        bonus.r += linhagens[ln].r || 0;
        bonus.v += linhagens[ln].v || 0;
        bonus.esp += linhagens[ln].esp || 0;
        bonus.ha += linhagens[ln].ha || 0;
        bonus.ho += linhagens[ln].ho || 0;
        bonus.hr += linhagens[ln].hr || 0;
        bonus.ami += linhagens[ln].ami || 0;

        if (ln === "Barnum") {
            bonus[i.selLinDF] += 0.1;
            bonus[i.selLinRV] += 0.2;
        } else if (ln === "D.") {
            bonus[i.selLin4] += 0.25;
            bonus[i.selLinEspAmi] += 0.2;
        } else if (ln === "Gan") {
            bonus[i.selLinDF] += 0.2;
        } else if (ln === "Kong") {
            bonus[i.selLin4] += 0.2;
        } else if (ln === "Silvers") {
            bonus[i.selLin4] += 0.15;
        } else if (ln === "Nico") {
            bonus[i.selLinDF] += 0.1;
            bonus[i.selLinRV] += 0.05;
        }
    }
    ...
    i.habilidadesExclusivas.sort((a, b) =>
        formatHabDisplay(a)
            .toLowerCase()
            .localeCompare(formatHabDisplay(b).toLowerCase()),
    );

    let habsDisponiveis = Object.keys(habilidadesExclusivasDict).filter(
        (hab) => !i.habilidadesExclusivas.includes(hab),
    );
    habsDisponiveis.sort((a, b) =>
        formatHabDisplay(a)
            .toLowerCase()
            .localeCompare(formatHabDisplay(b).toLowerCase()),
    );
    ...
    i.habilidadesExclusivas.forEach((hab) => {
        let isMandatoryLin =
            linhagemHabilidades[ln] && linhagemHabilidades[ln].includes(hab);
        let isMandatoryRace = !isMandatoryLin && mandHab.includes(hab);
        let mandText = isMandatoryLin
            ? "(Linhagem)"
            : isMandatoryRace
              ? "(Raça Exclusiva)"
              : "";
    ...
    if (habSelEl) habSelEl.innerHTML = habSelectHtml;
    let habListEl = document.getElementById("hab-list");
    if (habListEl) habListEl.innerHTML = habListHtml;
    ...
    if (habAtivosContainer) {
        ...
        if (elAtirador) {
            elAtirador.style.display = hasAtirador ? "block" : "none";
            document.getElementById("chk-atirador").checked =
                i.habCaminhoAtiradorAtivo;
        }
        let elQI = document.getElementById("hab-ativo-qi");
        if (elQI) {
            elQI.style.display = hasQI ? "block" : "none";
            document.getElementById("chk-qi").checked = i.habQIAvancadoAtivo;
        }
        let elBeckman = document.getElementById("hab-ativo-beckman");
        if (elBeckman) {
            elBeckman.style.display = isBeckman ? "block" : "none";
            document.getElementById("chk-beckman").checked =
                i.linhagemBeckmanArma;
        }
        ...
        if (elArmista) {
            ...
            let armOpts =
                '<option value="sem">Sem Arma</option><option value="generica">Arma Genérica</option><option value="favorita">Arma Favorita</option>';
            if (totalBase >= 10000)
                armOpts += '<option value="criacao">Criação Própria</option>';
            if (totalBase >= 15000)
                armOpts +=
                    '<option value="criacao_favorita">Arma Favorita + Criação Própria</option>';
            if (selArmAtivo.innerHTML !== armOpts)
                selArmAtivo.innerHTML = armOpts;
            if (
                !Array.from(selArmAtivo.options).some(
                    (o) => o.value === i.habFavArmistaAtivo,
                )
            ) {
                i.habFavArmistaAtivo = "sem";
            }
            selArmAtivo.value = i.habFavArmistaAtivo;
            document.getElementById("sel-armista-attr").value =
                i.habFavArmistaAttr;
        }
        let elFuria = document.getElementById("hab-ativo-furia");
        if (elFuria) {
        ...
        if (elRetorno) {
            elRetorno.style.display = hasRetorno ? "flex" : "none";
            document.getElementById("sel-retorno-uso").value =
                i.habRetornoUso || 1;
        }
    }

    if (hasHab("Arte da Esgrima")) {
        if (totalBase >= 15000) bonus.d += 0.2;
        else if (totalBase >= 10000) bonus.d += 0.15;
        else if (totalBase >= 5000) bonus.d += 0.1;
    }
    if (hasHab("Batedor de Carteiras")) {
        if (totalBase >= 15000) bonus.d += 0.25;
        else if (totalBase >= 10000) bonus.d += 0.2;
        else if (totalBase >= 5000) bonus.d += 0.15;
    }
    if (hasHab("Caminho do Atirador")) {
        if (totalBase >= 15000) bonus.d += 0.15;
        else if (totalBase >= 10000) bonus.d += 0.1;
        else if (totalBase >= 5000) bonus.d += 0.05;
        if (i.habCaminhoAtiradorAtivo) {
            if (totalBase >= 15000) bonus.d += 0.2;
            else if (totalBase >= 10000) bonus.d += 0.15;
            else if (totalBase >= 5000) bonus.d += 0.1;
    ...
    if (hasHab("Constituição Única")) {
        bonus.f += 0.1;
        bonus.r += 0.15;
    }
    if (hasHab("Contração Muscular")) {
        if (totalBase >= 10000) {
            bonus.f += 0.2;
            bonus.r += 0.2;
        } else if (totalBase >= 5000) {
    ...
    if (hasHab("Flexibilidade")) {
        if (totalBase >= 10000) bonus.v += 0.2;
        else if (totalBase >= 5000) bonus.v += 0.1;
    }
    if (hasHab("Fúria Ardente")) {
        let fA = i.habFuriaArdenteAttr || "f";
    ...
    if (hasHab("Pensamento Acelerado")) {
        if (totalBase >= 10000) bonus.refl += 0.25;
        else if (totalBase >= 5000) bonus.refl += 0.2;
    }
    if (hasHab("QI Avançado")) {
        if (i.habQIAvancadoAtivo) bonus.refl += 0.05;
    }
    if (isBeckman && i.linhagemBeckmanArma) {
        bonus.v += 0.05;
    }
    if (hasHab("Golpe de Retorno")) {
        let usos = i.habRetornoUso || 1;
        if (usos === 2) bonus.r -= 0.1;
        else if (usos === 3) bonus.r -= 0.2;
    }
    ...
    if (ln === "Beckman") estTotalVal = Math.floor(estTotalVal * 1.1);
    if (typeof i.lastEstTotal === "undefined") i.lastEstTotal = estTotalVal;
    if (
        estTotalVal !== i.lastEstTotal &&
        (i.estaminaAtual === 0 || i.estaminaAtual === i.lastEstTotal)
    )
        i.estaminaAtual = estTotalVal;
    i.lastEstTotal = estTotalVal;
    if (typeof i.estaminaAtual === "undefined" || i.estaminaAtual === -1)
        i.estaminaAtual = estTotalVal;
    ...
    let zoanBaseD = passiveD;
    if (zBonus.d > 0) zoanBaseD = Math.round(passiveD * (1 + zBonus.d));
    ...
    elTotalD.dataset.passive = passiveD;
    elTotalD.dataset.active = totalD;

    let passiveF = Math.round((F + flatBonus.f) * (1 + bonus.f));
    let zoanBaseF = passiveF;
    if (zBonus.f > 0) zoanBaseF = Math.round(passiveF * (1 + zBonus.f));
    ...
    elTotalF.dataset.passive = passiveF;
    elTotalF.dataset.active = totalF;

    let passiveR = Math.round((R + flatBonus.r) * (1 + bonus.r));
    let zoanBaseR = passiveR;
    if (zBonus.r > 0) zoanBaseR = Math.round(passiveR * (1 + zBonus.r));
    ...
    elTotalR.dataset.passive = passiveR;
    elTotalR.dataset.active = totalR;

    let waterBuffV = 0;
    if (ln !== "Charlotte") {
        if (rc === "Sereiano") waterBuffV += 0.3;
        if (rc === "Tritão") waterBuffV += 0.3;
        if (rc === "Wotan") waterBuffV += 0.15;
    } else {
        if (rc === "Sereiano" && i.selCharR1 === "v") waterBuffV += 0.3;
        if (rc === "Tritão" && i.selCharR1 === "v") waterBuffV += 0.3;
        if (rc === "Wotan" && i.selCharR1 === "v") waterBuffV += 0.15;
        if (rc2 === "Sereiano" && i.selCharR2 === "v") waterBuffV += 0.3;
        if (rc2 === "Tritão" && i.selCharR2 === "v") waterBuffV += 0.3;
    ...
    elTotalV.dataset.passive = passiveV;
    elTotalV.dataset.active = totalV;
    document.getElementById("container-boxVel").style.display =
        totalV > 0 ? "block" : "none";

    if (totalV === 0) {
        currentChar.substats.refl = 0;
        currentChar.substats.vcorp = 0;
    }

    let REF = currentChar.substats.refl || 0,
        VCORP = currentChar.substats.vcorp || 0;
    let totalVelSub = REF + VCORP;

    if (!isSuperAdmin && totalVelSub > totalV) {
        let diff = totalVelSub - totalV;
        let active = document.activeElement;
        if (active && active.id === "sub-refl") {
            REF -= diff;
            currentChar.substats.refl = REF;
        } else if (active && active.id === "sub-vcorp") {
            VCORP -= diff;
        ...
        document.getElementById("avisoVel").textContent =
            `Limite atingido!\n Máx: ${totalV.toLocaleString("pt-BR")}`;
    } else if (totalVelSub < totalV && totalV > 0) {
        let diff = totalV - totalVelSub;
        document.getElementById("avisoVel").style.display = "block";
        document.getElementById("avisoVel").textContent =
            `Pontos não distribuídos nos sub-atributos de Velocidade: ${diff.toLocaleString("pt-BR")}`;
    } else {
        document.getElementById("avisoVel").style.display = "none";
    }

    let elRefl = document.getElementById("sub-refl");
    let fmtRefl = currentChar.substats.refl
        ? currentChar.substats.refl.toLocaleString("pt-BR")
        : "";
    if (elRefl && elRefl.value !== fmtRefl) elRefl.value = fmtRefl;

    let elVcorp = document.getElementById("sub-vcorp");
    let fmtVcorp = currentChar.substats.vcorp
        ? currentChar.substats.vcorp.toLocaleString("pt-BR")
        : "";
    ...
    let hasWaterDiff =
        ...
        flatBonus.vAgua !== 0 ||
        bonus.reflAgua !== 0 ||
        flatBonus.reflAgua !== 0 ||
        bonus.vcorpAgua !== 0 ||
        flatBonus.vcorpAgua !== 0;
    ...
    if (elBoxVelAgua) {
        if (hasWaterDiff && V > 0) {
            ...
            let totalVAgua = Math.round(
                (V + totalFlatBonusVAgua) * (1 + totalBonusVAgua),
            );
            document.getElementById("total-vAgua").innerText =
                "Total na Água: " + totalVAgua.toLocaleString("pt-BR");

            if (typeof currentChar.substats.reflAgua === "undefined")
                currentChar.substats.reflAgua = 0;
            if (typeof currentChar.substats.vcorpAgua === "undefined")
                currentChar.substats.vcorpAgua = 0;

            let REFAgua = currentChar.substats.reflAgua || 0,
                VCORPAgua = currentChar.substats.vcorpAgua || 0;
            ...
            if (!isSuperAdmin && totalVelSubAgua > totalVAgua) {
                ...
                if (active && active.id === "sub-reflAgua") {
                    REFAgua -= diff;
                    if (isBuffAgua && REFAgua < REF) {
                        VCORPAgua -= REF - REFAgua;
                        REFAgua = REF;
                        currentChar.substats.vcorpAgua = VCORPAgua;
                    }
                    currentChar.substats.reflAgua = REFAgua;
                    ...
                    VCORPAgua -= diff;
                    if (isBuffAgua && VCORPAgua < VCORP) {
                        REFAgua -= VCORP - VCORPAgua;
                        VCORPAgua = VCORP;
                        currentChar.substats.reflAgua = REFAgua;
                    }
                    currentChar.substats.vcorpAgua = VCORPAgua;
                    ...
                    if (isBuffAgua) {
                        if (VCORPAgua - diff >= VCORP) {
                            VCORPAgua -= diff;
                            currentChar.substats.vcorpAgua = VCORPAgua;
                        } else if (REFAgua - diff >= REF) {
                            REFAgua -= diff;
                            currentChar.substats.reflAgua = REFAgua;
                        } else {
                            REFAgua = REF;
                ...
                document.getElementById("avisoVelAgua").style.display = "block";
                document.getElementById("avisoVelAgua").textContent =
                    `Limite atingido!\n Máx: ${totalVAgua.toLocaleString("pt-BR")}`;
            } else if (totalVelSubAgua < totalVAgua && totalVAgua > 0) {
                let diff = totalVAgua - totalVelSubAgua;
                document.getElementById("avisoVelAgua").style.display = "block";
                document.getElementById("avisoVelAgua").textContent =
                    `Pontos não distribuídos na Água: ${diff.toLocaleString("pt-BR")}`;
            } else {
                document.getElementById("avisoVelAgua").style.display = "none";
            }

            let elReflAgua = document.getElementById("sub-reflAgua");
            let fmtReflAgua = currentChar.substats.reflAgua
                ? currentChar.substats.reflAgua.toLocaleString("pt-BR")
                : "";
            if (elReflAgua && elReflAgua.value !== fmtReflAgua)
                elReflAgua.value = fmtReflAgua;

            let elVcorpAgua = document.getElementById("sub-vcorpAgua");
            let fmtVcorpAgua = currentChar.substats.vcorpAgua
                ? currentChar.substats.vcorpAgua.toLocaleString("pt-BR")
                : "";
            if (elVcorpAgua && elVcorpAgua.value !== fmtVcorpAgua)
                elVcorpAgua.value = fmtVcorpAgua;
        } else {
            elBoxVelAgua.style.display = "none";
            if (currentChar.substats.reflAgua)
                currentChar.substats.reflAgua = 0;
            if (currentChar.substats.vcorpAgua)
                currentChar.substats.vcorpAgua = 0;
        }
    }
    ...
    let tempAAlc = currentChar.substats.amiAlc || 0,
        ...
        tempAVel = currentChar.substats.amiVel || 0;
    let tempBaseAmiStats = 0;
    if (i.hasAmiAlc) tempBaseAmiStats++;
    if (i.hasAmiDur) tempBaseAmiStats++;
    if (i.hasAmiPot) tempBaseAmiStats++;
    if (i.hasAmiVel) tempBaseAmiStats++;
    let tempControlePct = 0;
    if (tempBaseAmiStats > 0) {
        let currentBasePoints = tempAAlc + tempADur + tempAPot + tempAVel;
        tempControlePct = parseFloat(
            ((currentBasePoints / (tempBaseAmiStats * 10000)) * 100).toFixed(2),
        );
    }
    ...
    if (i.hasAmiVel && calcAVelFinalBox > 0) {
        let baseAkumaVelBox = Math.floor(
            calcAVelFinalBox * (tempControlePct / 100),
        );
        let buffAmiVelValBox = parseInt(i.amiVelBuff) || 0;
        if (buffAmiVelValBox > 0)
            finalAkumaVelBox =
                baseAkumaVelBox +
                Math.floor(baseAkumaVelBox * (buffAmiVelValBox / 100));
    ...
    let totalEsp = Math.round(
        (passiveEsp + itemFlat.esp) * (1 + itemBonus.esp),
    );
    document.getElementById("total-esp").innerText =
        "Total: " + totalEsp.toLocaleString("pt-BR");

    let HA = currentChar.substats.hArm || 0,
        HO = currentChar.substats.hObs || 0,
        HR = currentChar.substats.hRei || 0;
    let totalHaki = HA + HO + HR;

    if (!isSuperAdmin && totalHaki > totalEsp) {
        let diff = totalHaki - totalEsp;
        let active = document.activeElement;
        if (active && active.id === "sub-hArm") {
            HA -= diff;
            currentChar.substats.hArm = HA;
        } else if (active && active.id === "sub-hObs") {
            HO -= diff;
            currentChar.substats.hObs = HO;
        } else if (active && active.id === "sub-hRei") {
            HR -= diff;
            currentChar.substats.hRei = HR;
        } else {
            if (HR >= diff) {
                HR -= diff;
                currentChar.substats.hRei = HR;
        ...
        document.getElementById("avisoEsp").textContent =
            `Limite atingido! Máx: ${totalEsp.toLocaleString("pt-BR")}`;
    } else if (totalHaki < totalEsp && totalEsp > 0) {
        let diff = totalEsp - totalHaki;
        document.getElementById("avisoEsp").style.display = "block";
        document.getElementById("avisoEsp").textContent =
            `Pontos não distribuídos nos sub-atributos de Espírito: ${diff.toLocaleString("pt-BR")}`;
    } else {
        document.getElementById("avisoEsp").style.display = "none";
    }

    let elHArm = document.getElementById("sub-hArm");
    let fmtHArm = currentChar.substats.hArm
        ? currentChar.substats.hArm.toLocaleString("pt-BR")
        : "";
    if (elHArm && elHArm.value !== fmtHArm) elHArm.value = fmtHArm;

    let elHObs = document.getElementById("sub-hObs");
    let fmtHObs = currentChar.substats.hObs
        ? currentChar.substats.hObs.toLocaleString("pt-BR")
        : "";
    if (elHObs && elHObs.value !== fmtHObs) elHObs.value = fmtHObs;

    let elHRei = document.getElementById("sub-hRei");
    let fmtHRei = currentChar.substats.hRei
        ? currentChar.substats.hRei.toLocaleString("pt-BR")
        : "";
    ...
    document.getElementById("cont-ha2").style.display =
        haPts > 0 && i.unlockHA1 ? "block" : "none";
    document.getElementById("cont-ha3").style.display =
        haPts >= 3000 && i.unlockHA2 ? "block" : "none";
    document.getElementById("cont-ha4").style.display =
        haPts >= 5000 && i.unlockHA2 ? "block" : "none";
    document.getElementById("cont-ha5").style.display =
    ...
    document.getElementById("cont-hr3").style.display =
        hrPts >= 3000 && i.unlockHR2 ? "block" : "none";
    document.getElementById("cont-hr4").style.display =
        hrPts >= 5000 && i.unlockHR3 ? "block" : "none";
    document.getElementById("cont-hr5").style.display =
        hrPts >= 7500 && hoPts >= 8000 && i.unlockHO4 ? "block" : "none";
    document.getElementById("cont-hr6").style.display =
        hrPts >= 10000 &&
        i.unlockHA1 &&
        i.unlockHA2 &&
        i.unlockHA3 &&
    ...
    let baseAmiStats = 0;
    if (i.hasAmiAlc) baseAmiStats++;
    if (i.hasAmiDur) baseAmiStats++;
    ...
    document.getElementById("box-amiSub").style.display = temFruta
        ? "block"
        : "none";
    if (AMI === 0) {
        currentChar.substats.amiAlc = 0;
    ...
    let aAlc = currentChar.substats.amiAlc || 0,
        aDur = currentChar.substats.amiDur || 0,
    ...
    if (baseAmiStats > 0) {
        ...
        controlePct = parseFloat(
            ((currentBasePoints / (baseAmiStats * 10000)) * 100).toFixed(2),
        );
    }
    ...
    if (despContainer) {
        if (isSuperAdmin || controlePct >= 100) {
            ...
            if (aDesp > 0 || i.hasAmiDesp) {
                ...
                i.hasAmiDesp = false;
                aDesp = 0;
                let chkDesp = document.getElementById("chk-amiDesp");
    ...
    if (!isSuperAdmin) {
        if (aAlc > maxAmiPoints) {
            aAlc = maxAmiPoints;
            currentChar.substats.amiAlc = maxAmiPoints;
            limitAmiExcedido = true;
        }
        if (aDur > maxAmiPoints) {
            aDur = maxAmiPoints;
            currentChar.substats.amiDur = maxAmiPoints;
            limitAmiExcedido = true;
        }
        if (aPot > maxAmiPoints) {
            aPot = maxAmiPoints;
            currentChar.substats.amiPot = maxAmiPoints;
            limitAmiExcedido = true;
        }
        if (aVel > maxAmiPoints) {
            aVel = maxAmiPoints;
            currentChar.substats.amiVel = maxAmiPoints;
            limitAmiExcedido = true;
        }
        if (aDesp > maxAmiPoints) {
            aDesp = maxAmiPoints;
            currentChar.substats.amiDesp = maxAmiPoints;
            limitAmiExcedido = true;
        }
    }
    ...
    if (elDisp)
        elDisp.textContent = `Disponível: ${Math.max(0, pontosDisponiveis).toLocaleString("pt-BR")}`;

    if (!isSuperAdmin && totalAmiSub > totalAmi) {
        let diff = totalAmiSub - totalAmi;
        let active = document.activeElement;
        if (active && active.id === "sub-amiAlc") {
            aAlc -= diff;
            currentChar.substats.amiAlc = Math.max(0, aAlc);
        } else if (active && active.id === "sub-amiDur") {
            aDur -= diff;
            currentChar.substats.amiDur = Math.max(0, aDur);
        } else if (active && active.id === "sub-amiPot") {
            aPot -= diff;
            currentChar.substats.amiPot = Math.max(0, aPot);
        ...
        document.getElementById("avisoAmi").textContent =
            `Limite atingido! Máx: ${totalAmi.toLocaleString("pt-BR")}`;
    } else if (limitAmiExcedido) {
        document.getElementById("avisoAmi").style.display = "block";
        document.getElementById("avisoAmi").textContent =
            `Máximo de ${maxAmiPoints.toLocaleString("pt-BR")} pontos por atributo alcançado!`;
    } else {
        document.getElementById("avisoAmi").style.display = "none";
    }

    let elAmiAlc = document.getElementById("sub-amiAlc");
    let fmtAmiAlc = currentChar.substats.amiAlc
        ? currentChar.substats.amiAlc.toLocaleString("pt-BR")
        : "";
    if (elAmiAlc && elAmiAlc.value !== fmtAmiAlc) elAmiAlc.value = fmtAmiAlc;

    let elAmiDur = document.getElementById("sub-amiDur");
    let fmtAmiDur = currentChar.substats.amiDur
        ? currentChar.substats.amiDur.toLocaleString("pt-BR")
        : "";
    if (elAmiDur && elAmiDur.value !== fmtAmiDur) elAmiDur.value = fmtAmiDur;

    let elAmiPot = document.getElementById("sub-amiPot");
    let fmtAmiPot = currentChar.substats.amiPot
        ? currentChar.substats.amiPot.toLocaleString("pt-BR")
        : "";
    if (elAmiPot && elAmiPot.value !== fmtAmiPot) elAmiPot.value = fmtAmiPot;

    let elAmiVel = document.getElementById("sub-amiVel");
    let fmtAmiVel = currentChar.substats.amiVel
        ? currentChar.substats.amiVel.toLocaleString("pt-BR")
        : "";
    if (elAmiVel && elAmiVel.value !== fmtAmiVel) elAmiVel.value = fmtAmiVel;

    let despEl2 = document.getElementById("sub-amiDesp");
    let fmtDesp = currentChar.substats.amiDesp
        ? currentChar.substats.amiDesp.toLocaleString("pt-BR")
        : "";
    if (despEl2 && despEl2.value !== fmtDesp) despEl2.value = fmtDesp;

    let amiResPctVal = parseInt(i.amiResPct) || 0;
    let calcAPotRes = Math.round(
        (aPot + flatBonus.amiPot) * (1 + bonus.amiPot),
    );
    if (amiResPctVal > 0 && calcAPotRes > 0) {
        let totalPotResCalc =
            calcAPotRes + Math.floor(calcAPotRes * (amiResPctVal / 100));
        document.getElementById("ami-res-total").textContent =
            `(${calcAPotRes.toLocaleString("pt-BR")} + ${amiResPctVal}% = ${totalPotResCalc.toLocaleString("pt-BR")} de Resistência)`;
    } else {
        document.getElementById("ami-res-total").textContent = "";
    }
    ...
    if (calcAVelUI > 0) {
        ...
        if (amiVelBuffVal > 0) {
            finalAkumaVelUI =
                baseAkumaVelUI +
                Math.floor(baseAkumaVelUI * (amiVelBuffVal / 100));
            document.getElementById("ami-vel-total").textContent =
                `(${baseAkumaVelUI.toLocaleString("pt-BR")}+${amiVelBuffVal}% = ${finalAkumaVelUI.toLocaleString("pt-BR")} de Velocidade Adicional)`;
        } else {
            document.getElementById("ami-vel-total").textContent =
                `(+${baseAkumaVelUI.toLocaleString("pt-BR")} de Velocidade Adicional)`;
        }
    } else {
    ...
    if (elCalcUseHakiSelect) {
        ...
        if (
            Array.from(elCalcUseHakiSelect.options).some(
                (o) => o.value === i.calcUseHaki,
            )
        ) {
    ...
    if (elCalcUseHakiReiSelect) {
        ...
        if (
            Array.from(elCalcUseHakiReiSelect.options).some(
                (o) => o.value === i.calcUseHakiRei,
            )
        ) {
    ...
    if (i.calcQuemAtaca === "inimigo") {
        ...
        if (calcHA > 0) {
            if (i.calcUseHaki === "invisivel")
                ...
                danoHaki = Math.floor(calcHA * 0.5);
            else if (i.calcUseHaki === "imbuicao")
                danoHaki = Math.floor(calcHA * 0.8);
    ...
    if (totalIgnRes > 0) {
        calcResBruta =
            calcResInimiga - Math.floor(calcResInimiga * (totalIgnRes / 100));
    }
    ...
    if (i.calcQuemAtaca === "inimigo") {
        let getReductions = (buffs) => {
            buffs.forEach((b) => {
                if (b.stat === "ignDanoGeral")
                    reducaoDanoGeral += parseInt(b.val) || 0;
                else if (b.stat === "ignDanoAmi")
                    reducaoDanoAmi += parseInt(b.val) || 0;
            });
        };
    ...
    if (
        hasHab("Espírito Contagiante") &&
        totalBase >= 15000 &&
        i.calcQuemAtaca === "inimigo"
    ) {
        reducaoDanoGeral += 10;
    }
    ...
    if (reducaoDanoAmi > 0) {
        danoAmi = Math.max(
            0,
            danoAmi - Math.floor(danoAmi * (reducaoDanoAmi / 100)),
        );
    }
    ...
    let extraFlatDano =
        i.calcQuemAtaca === "inimigo"
            ? 0
            : (flatBonus.dano || 0) + (itemFlat.dano || 0);
    let extraPctDano =
        i.calcQuemAtaca === "inimigo"
            ? 0
    ...
    if (totalPctDano !== 0) {
        calcDanoFinal =
            baseComFlat + Math.floor(baseComFlat * (totalPctDano / 100));
    }
    ...
    document.getElementById("calc-dano-final").textContent =
        calcDanoFinal.toLocaleString("pt-BR");
    ...
    if (
        ...
        if (buffFlat > 0)
            calcFormTexto += ` <span style="color:#ffc107;">+ ${buffFlat.toLocaleString("pt-BR")} (Bônus de Estilo) = ${step1Attr.toLocaleString("pt-BR")}</span>`;
        if (buffPct !== 0)
            calcFormTexto += ` <span style="color:#198754;">+ ${buffPct}% (Buff Ativo) = ${calcAttrSemAmi.toLocaleString("pt-BR")}</span>`;
    ...
    document.getElementById("estamina-total").textContent =
        estTotalVal.toLocaleString("pt-BR");
    ...
    let custoVel = Math.floor(eVel * 0.1);
    let custoDano = Math.floor(eDano * 0.1);
    ...
    if (qtdEspiritoEst > 0) {
        ...
        fontesRedEstamina.push(
            qtdEspiritoEst > 1
                ? `Aliados c/ Espírito (${qtdEspiritoEst}x)`
                : "Aliado c/ Espírito",
        );
    }
    if (hasHab("QI Avançado")) {
    ...
    document.getElementById("estamina-custo-final").textContent =
        custoEstTotal.toLocaleString("pt-BR");

    let estFormula = "";
    if (custoBruto > 0) {
        if (custoVel > 0)
            estFormula += `<span style="color:#0dcaf0;">+ ${custoVel.toLocaleString("pt-BR")} (10% de Vel.)</span><br>`;
        if (custoDano > 0)
            estFormula += `<span style="color:#dc3545;">+ ${custoDano.toLocaleString("pt-BR")} (10% de Dano)</span><br>`;
        if (custoBuff > 0)
            estFormula += `<span style="color:#198754;">+ ${custoBuff.toLocaleString("pt-BR")} (${eBuff}% de Buff)</span><br>`;
        if (custoHaki > 0)
    ...
    let totalHP =
        10000 +
        Math.floor(
            Math.round((rHP + flatBonus.r) * (1 + bonus.r)) * hpMultiplier,
        );
    ...
    if (typeof i.hpAtual === "undefined" || i.hpAtual === -1)
        i.hpAtual = totalHP;
    ...
    if (
        !i.hidePersonality &&
        i.personalidade &&
        i.personalidade.trim() !== ""
    ) {
        histPersOut += `\n  : ᓩ _𝐏ᴇʀsᴏɴᴀʟɪᴅᴀᴅᴇ:_\n${formatHistPers(i.personalidade)}\n`;
    }
    if (!i.hideHistoria && i.historia && i.historia.trim() !== "") {
    ...
    let calcAVelFinal = Math.round(
        (aVelOut + flatBonus.amiVel) * (1 + bonus.amiVel),
    );
    let finalAkumaVel = 0;
    if (i.hasAmiVel && calcAVelFinal > 0) {
        ...
        if (buffAmiVelVal > 0) {
            finalAkumaVel =
                baseAkumaVel + Math.floor(baseAkumaVel * (buffAmiVelVal / 100));
        } else {
    ...
    if (V > 0) {
        ...
        if (hasWaterDiff) {
            ...
            if (REF > 0 || REFAgua > 0 || REFAkuma > 0) {
                let refNormStr = "";
                if (REF > 0 || REFAkuma > 0) {
                    let totalBaseRef = Math.round(
                        (Math.round((REF + flatBonus.refl) * (1 + bonus.refl)) +
                            itemFlat.refl) *
                            (1 + itemBonus.refl),
                    );
                    if (
                        ...
                        refNormStr = (totalBaseRef + REFAkuma).toLocaleString(
                            "pt-BR",
                        );
                    else {
                        refNormStr = strCalc(
                        ...
                        if (REFAkuma > 0) {
                            let ptsStr = refNormStr.includes("=")
                                ? refNormStr.substring(
                                      0,
                                      refNormStr.lastIndexOf(" = "),
                                  )
                                : refNormStr;
                            refNormStr =
                                ptsStr +
                                `+${REFAkuma.toLocaleString("pt-BR")} (Akuma) = ${(totalBaseRef + REFAkuma).toLocaleString("pt-BR")}`;
                        }
                    }
                }
                let refWaterStr = "";
                if (REFAgua > 0 || REFAkuma > 0) {
                    let totalBaseRefAgua = Math.round(
                        (Math.round(
                            (REFAgua + totalFlatBonusReflAgua) *
                                (1 + totalBonusReflAgua),
                        ) +
                            itemFlat.reflAgua) *
                            (1 + itemBonus.reflAgua),
                    );
                    if (
                        totalBonusReflAgua === 0 &&
                        totalFlatBonusReflAgua === 0 &&
                        itemBonus.reflAgua === 0 &&
                        itemFlat.reflAgua === 0
                    )
                        refWaterStr = (
                            totalBaseRefAgua + REFAkuma
                        ).toLocaleString("pt-BR");
                    else {
                        refWaterStr = strCalc(
                            REFAgua,
                            totalBonusReflAgua,
                            totalFlatBonusReflAgua,
                            itemBonus.reflAgua,
                            itemFlat.reflAgua,
                        );
                        if (REFAkuma > 0) {
                            let ptsStr = refWaterStr.includes("=")
                                ? refWaterStr.substring(
                                      0,
                                      refWaterStr.lastIndexOf(" = "),
                                  )
                                : refWaterStr;
                            refWaterStr =
                                ptsStr +
                                `+${REFAkuma.toLocaleString("pt-BR")} (Akuma) = ${(totalBaseRefAgua + REFAkuma).toLocaleString("pt-BR")}`;
                        }
                    }
                }
                if ((REF > 0 || REFAkuma > 0) && (REFAgua > 0 || REFAkuma > 0))
                    attrOut += `> _𝚁𝚎𝚏𝚕𝚎𝚡𝚘:_ ${refNormStr} | ${refWaterStr} (dentro d'água)\n`;
                else if (REF > 0 || REFAkuma > 0)
                    attrOut += `> _𝚁𝚎𝚏𝚕𝚎𝚡𝚘:_ ${refNormStr}\n`;
                else if (REFAgua > 0 || REFAkuma > 0)
                    attrOut += `> _𝚁𝚎𝚏𝚕𝚎𝚡𝚘 (𝙳𝚎𝚗𝚝𝚛𝚘 𝚍'𝚊́𝚐𝚞𝚊):_ ${refWaterStr}\n`;
            }
            if (VCORP > 0 || VCORPAgua > 0 || VCORPAkuma > 0) {
                let vcorpNormStr = "";
                if (VCORP > 0 || VCORPAkuma > 0) {
                    let totalBaseVcorp = Math.round(
                        (Math.round(
                            (VCORP + flatBonus.vcorp) * (1 + bonus.vcorp),
                        ) +
                            itemFlat.vcorp) *
                            (1 + itemBonus.vcorp),
                    );
                    if (
                        ...
                        vcorpNormStr = (
                            totalBaseVcorp + VCORPAkuma
                        ).toLocaleString("pt-BR");
                    else {
                        vcorpNormStr = strCalc(
                            VCORP,
                            bonus.vcorp,
                            flatBonus.vcorp,
                            itemBonus.vcorp,
                        ...
                        if (VCORPAkuma > 0) {
                            let ptsStr = vcorpNormStr.includes("=")
                                ? vcorpNormStr.substring(
                                      0,
                                      vcorpNormStr.lastIndexOf(" = "),
                                  )
                                : vcorpNormStr;
                            vcorpNormStr =
                                ptsStr +
                                `+${VCORPAkuma.toLocaleString("pt-BR")} (Akuma) = ${(totalBaseVcorp + VCORPAkuma).toLocaleString("pt-BR")}`;
                        }
                    }
                }
                let vcorpWaterStr = "";
                if (VCORPAgua > 0 || VCORPAkuma > 0) {
                    let totalBaseVcorpAgua = Math.round(
                        (Math.round(
                            (VCORPAgua + totalFlatBonusVcorpAgua) *
                                (1 + totalBonusVcorpAgua),
                        ) +
                            itemFlat.vcorpAgua) *
                            (1 + itemBonus.vcorpAgua),
                    );
                    if (
                        totalBonusVcorpAgua === 0 &&
                        totalFlatBonusVcorpAgua === 0 &&
                        itemBonus.vcorpAgua === 0 &&
                        itemFlat.vcorpAgua === 0
                    )
                        vcorpWaterStr = (
                            totalBaseVcorpAgua + VCORPAkuma
                        ).toLocaleString("pt-BR");
                    else {
                        vcorpWaterStr = strCalc(
                            VCORPAgua,
                            totalBonusVcorpAgua,
                            totalFlatBonusVcorpAgua,
                            itemBonus.vcorpAgua,
                            itemFlat.vcorpAgua,
                        );
                        if (VCORPAkuma > 0) {
                            let ptsStr = vcorpWaterStr.includes("=")
                                ? vcorpWaterStr.substring(
                                      0,
                                      vcorpWaterStr.lastIndexOf(" = "),
                                  )
                                : vcorpWaterStr;
                            vcorpWaterStr =
                                ptsStr +
                                `+${VCORPAkuma.toLocaleString("pt-BR")} (Akuma) = ${(totalBaseVcorpAgua + VCORPAkuma).toLocaleString("pt-BR")}`;
                        }
                    }
                }
                if (
                    (VCORP > 0 || VCORPAkuma > 0) &&
                    (VCORPAgua > 0 || VCORPAkuma > 0)
                )
                    attrOut += `> _𝚅𝚎𝚕𝚘𝚌𝚒𝚍𝚊𝚍𝚎 𝙲𝚘𝚛𝚙𝚘𝚛𝚊𝚕:_ ${vcorpNormStr} | ${vcorpWaterStr} (dentro d'água)\n`;
                else if (VCORP > 0 || VCORPAkuma > 0)
                    attrOut += `> _𝚅𝚎𝚕𝚘𝚌𝚒𝚍𝚊𝚍𝚎 𝙲𝚘𝚛𝚙𝚘𝚛𝚊𝚕:_ ${vcorpNormStr}\n`;
                else if (VCORPAgua > 0 || VCORPAkuma > 0)
                    attrOut += `> _𝚅𝚎𝚕𝚘𝚌𝚒𝚍𝚊𝚍𝚎 𝙲𝚘𝚛𝚙𝚘𝚛𝚊𝚕 (𝙳𝚎𝚗𝚝𝚛𝚘 𝚍'𝚊́𝚐𝚞𝚊):_ ${vcorpWaterStr}\n`;
            }
        } else {
            ...
            if (REF > 0 || REFAkuma > 0) {
                ...
                if (
                    ...
                    attrOut += `> _𝚁𝚎𝚏𝚕𝚎𝚡𝚘:_ ${(totalBaseRef + REFAkuma).toLocaleString("pt-BR")}\n`;
                else {
                    let refNormStr = strCalc(
                        REF,
                        bonus.refl,
                        flatBonus.refl,
                        itemBonus.refl,
            ...
            if (VCORP > 0 || VCORPAkuma > 0) {
                let totalBaseVcorp = Math.round(
                    (Math.round((VCORP + flatBonus.vcorp) * (1 + bonus.vcorp)) +
                        itemFlat.vcorp) *
                        (1 + itemBonus.vcorp),
                );
                if (
                    ...
                    attrOut += `> _𝚅𝚎𝚕𝚘𝚌𝚒𝚍𝚊𝚍𝚎 𝙲𝚘𝚛𝚙𝚘𝚛𝚊𝚕:_ ${(totalBaseVcorp + VCORPAkuma).toLocaleString("pt-BR")}\n`;
                else {
                    let vcorpNormStr = strCalc(
                        VCORP,
                        bonus.vcorp,
                        flatBonus.vcorp,
                        itemBonus.vcorp,
    ...
    if (listC.length > 0) {
        listC.sort((a, b) => {
            let qA =
                parseInt(String(a.quantidade || "").replace(/\D/g, "")) || 0;
            let qB =
                parseInt(String(b.quantidade || "").replace(/\D/g, "")) || 0;
            if (qA !== qB) return qB - qA;
            let pA = parseInt(String(a.pontos || "").replace(/\D/g, "")) || 0;
            let pB = parseInt(String(b.pontos || "").replace(/\D/g, "")) || 0;
            if (pA !== pB) return pB - pA;
            let rA = (a.raca || "").toLowerCase();
            let rB = (b.raca || "").toLowerCase();
            return rA.localeCompare(rB);
        });
        listC.forEach((n) => {
            let rFormatada = (n.raca || "Humano").toLowerCase();
            if (
                (parseInt(String(n.quantidade || "").replace(/\D/g, "")) || 0) >
                1
            ) {
            ...
            let qtdStr = cleanQtdStr
                ? (parseInt(cleanQtdStr) || 0).toLocaleString("pt-BR")
                : "0";
            if (ptsNum === 0) {
            ...
            [n.classe, n.classe2, n.classe3].forEach((c) => {
                if (c) {
                    ...
                    if (match) {
                        let base = match[1];
                        let lvl = parseInt(match[2]);
                        if (!maxLvl[base] || lvl > maxLvl[base])
                            maxLvl[base] = lvl;
                    }
                }
            });
    ...
    let hasValidTecnica =
        ...
        currentChar.tecnicasList.some((t) => t.nome || t.desc || t.efeito);
    ...
    if (i.orgTipo === "Pirata" || i.orgTipo === "Caçador de Recompensa") {
        let labelOrg =
            i.orgTipo === "Pirata"
                ? i.pirataStatus && i.pirataStatus !== "Normal"
                    ? i.pirataStatus
                    : "Pirata"
        ...
        if (displayPatente !== "") {
            let gKey = i.sexo === "Feminino" ? "f" : "m";
            displayPatente = patenteGender[displayPatente]
                ? patenteGender[displayPatente][gKey]
                : displayPatente;
        }
    ...
    let outRecompensa = i.recompensa
        ? `฿${i.recompensa.toLocaleString("pt-BR")}`
        : "🔒";
    ...
    let formatStyle = (n) => {
        ...
        if (st === "Freestyle")
            return i["freestyle" + n] && i["freestyle" + n].trim() !== ""
                ? `Freestyle: ${i["freestyle" + n]}`
                : "Freestyle";
        return st;
    };
    ...
    let c2Out = i.classe2
        ? getClassDisplayName(i.classe2, i.sexo)
        : isSp
          ? "𝙸𝚗𝚒𝚌𝚒𝚊𝚕"
          : "5.000";
    let c3Out = i.classe3 ? getClassDisplayName(i.classe3, i.sexo) : "10.000";
    let c4Out = i.classe4
        ? getClassDisplayName(i.classe4, i.sexo)
        : isSp
          ? "15.000"
          : "20.000";
    let c5Out = i.classe5
    ...
    let racaOutput =
        isNPC && i.raca === "Outra"
            ...
            : formatRaceStr(i.raca, i.animal, i.sexo === "Feminino") || "";
    if (i.linhagem === "Charlotte") {
        let raca2Output =
            isNPC && i.raca2 === "Outra"
                ? i.racaNomeCustom2 || "2ª Raça Custom"
                : formatRaceStr(i.raca2, i.animal2, i.sexo === "Feminino") ||
                  "";
        ...
        let formatAlcunha = (alcObj) => {
            if (alcObj && alcObj.buffs && alcObj.buffs.length > 0) {
                ...
                alcObj.buffs.forEach((b) => {
                    let cName =
                        b.cond && b.cond.trim() !== "" ? b.cond.trim() : "";
    ...
    if (i.orgTipo === "Pirata" && i.pirataStatus === "Shichibukai") {
        ...
        let labelRecompensa =
            i.orgTipo === "Pirata" ||
            i.orgTipo === "Vanguarda Popular Revolucionária"
                ? "𝐑ᴇᴄᴏᴍᴘᴇɴsᴀ"
                : "𝐑ᴇᴄᴏᴍᴘᴇɴsᴀ 𝐏ᴏᴛᴇɴᴄɪᴀʟ";
        let valorRecompensa =
            i.orgTipo !== "Pirata" &&
            i.orgTipo !== "Vanguarda Popular Revolucionária"
                ? `~${outRecompensa}~`
    ...
    if (i.habilidadesExclusivas && i.habilidadesExclusivas.length > 0) {
        ...
        let getHabDesc = (hab, tb) => {
            if (hab === "Arte da Esgrima") {
                if (tb >= 15000)
                    return "+20% Destreza, -20% gasto de Estamina.";
                if (tb >= 10000)
                    return "+15% Destreza, -20% gasto de Estamina.";
                if (tb >= 5000) return "+10% Destreza, -20% gasto de Estamina.";
                return "";
            }
            if (hab === "Batedor de Carteiras") {
                if (tb >= 15000) return "+25% Destreza.";
                if (tb >= 10000) return "+20% Destreza.";
                if (tb >= 5000) return "+15% Destreza.";
                return "";
            }
            if (hab === "Caminho do Atirador") {
                if (tb >= 15000) return "+15% Destreza (+20% atirando).";
                if (tb >= 10000) return "+10% Destreza (+15% atirando).";
                if (tb >= 5000) return "+5% Destreza (+10% atirando).";
                return "";
            }
            if (hab === "Constituição Única")
                return "+10% Força, +15% Resistência.";
            if (hab === "Contração Muscular") {
                if (tb >= 10000) return "+20% Força e Resistência.";
                if (tb >= 5000) return "+10% Força e Resistência.";
                return "";
            }
            ...
            if (hab === "Filho do Mar") {
                if (tb >= 15000) return "+15% Reflexo e Resistência.";
                if (tb >= 10000) return "+10% Reflexo e Resistência.";
                if (tb >= 5000) return "+5% Reflexo e Resistência.";
                return "";
            }
            if (hasHab("Flexibilidade")) {
                if (totalBase >= 10000) bonus.v += 0.2;
            ...
            if (hab === "O Escolhido") {
                if (tb >= 20000) return "+15% em todos os Hakis.";
                if (tb >= 10000) return "+10% em todos os Hakis.";
                if (tb >= 5000) return "+5% em todos os Hakis.";
                return "";
            }
            if (hab === "Pensamento Acelerado") {
                if (tb >= 10000) return "+25% Reflexos.";
                if (tb >= 5000) return "+20% Reflexos.";
                return "";
            }
            if (hab === "QI Avançado")
                return "-50% gasto de Estamina. +5% Reflexos se durar >3 turnos.";
            return "oculta";
        };
        ...
        i.habilidadesExclusivas.forEach((hab) => {
            ...
            let isMandatoryLin =
                linhagemHabilidades[ln] &&
                linhagemHabilidades[ln].includes(hab);
            let isMandatoryRace = !isMandatoryLin && mandHab.includes(hab);
            let specText = isMandatoryLin
                ? " _*(Linhagem)*_"
                : isMandatoryRace
                  ? " _*(Raça Exclusiva)*_"
                  : "";
    ...
    let VCORPAkumaMan = i.amiVelAtivo
        ? currentChar.substats.vcorpAkuma || 0
        : 0;
    let hasWaterDiffMan =
        waterBuffV !== 0 ||
    ...
    if (hasWaterDiffMan) {
        ...
        if (i.amiVelAtivo && finalAkumaVel > 0) {
            let totalVAguaBase = Math.round(
                (Math.round((V + totalFlatBonusVAgua) * (1 + totalBonusVAgua)) +
                    itemFlat.v) *
                    (1 + itemBonus.v),
            );
        ...
        if (
            ...
            refNormStr = (totalBaseRef + REFAkumaMan).toLocaleString("pt-BR");
        else {
            refNormStr = strCalc(
                REF,
                bonus.refl,
            ...
            if (REFAkumaMan > 0) {
                let ptsStr = refNormStr.includes("=")
                    ? refNormStr.substring(0, refNormStr.lastIndexOf(" = "))
                    : refNormStr;
                refNormStr =
                    ptsStr +
                    `+${REFAkumaMan.toLocaleString("pt-BR")} (Akuma) = ${(totalBaseRef + REFAkumaMan).toLocaleString("pt-BR")}`;
            }
        }
        ...
        let totalBaseRefAgua = Math.round(
            (Math.round(
                (REFAgua + totalFlatBonusReflAgua) * (1 + totalBonusReflAgua),
            ) +
                itemFlat.reflAgua) *
                (1 + itemBonus.reflAgua),
        );
        if (
            ...
            refWaterStr = (totalBaseRefAgua + REFAkumaMan).toLocaleString(
                "pt-BR",
            );
        else {
            refWaterStr = strCalc(
            ...
            if (REFAkumaMan > 0) {
                let ptsStr = refWaterStr.includes("=")
                    ? refWaterStr.substring(0, refWaterStr.lastIndexOf(" = "))
                    : refWaterStr;
                refWaterStr =
                    ptsStr +
                    `+${REFAkumaMan.toLocaleString("pt-BR")} (Akuma) = ${(totalBaseRefAgua + REFAkumaMan).toLocaleString("pt-BR")}`;
            }
        }
        ...
        if (
            ...
            vcorpNormStr = (totalBaseVcorp + VCORPAkumaMan).toLocaleString(
                "pt-BR",
            );
        else {
            vcorpNormStr = strCalc(
            ...
            if (VCORPAkumaMan > 0) {
                let ptsStr = vcorpNormStr.includes("=")
                    ? vcorpNormStr.substring(0, vcorpNormStr.lastIndexOf(" = "))
                    : vcorpNormStr;
                vcorpNormStr =
                    ptsStr +
                    `+${VCORPAkumaMan.toLocaleString("pt-BR")} (Akuma) = ${(totalBaseVcorp + VCORPAkumaMan).toLocaleString("pt-BR")}`;
            }
        }
        ...
        if (
            ...
            vcorpWaterStr = (totalBaseVcorpAgua + VCORPAkumaMan).toLocaleString(
                "pt-BR",
            );
        else {
            vcorpWaterStr = strCalc(
            ...
            if (VCORPAkumaMan > 0) {
                ...
                vcorpWaterStr =
                    ptsStr +
                    `+${VCORPAkumaMan.toLocaleString("pt-BR")} (Akuma) = ${(totalBaseVcorpAgua + VCORPAkumaMan).toLocaleString("pt-BR")}`;
            }
        }
        ...
        if (
            ...
            manualAttrOut += `> _𝚁𝚎𝚏𝚕𝚎𝚡𝚘:_ ${(totalBaseRef + REFAkumaMan).toLocaleString("pt-BR")}\n`;
        else {
            let refNormStr = strCalc(
                REF,
                bonus.refl,
        ...
        if (
            ...
            manualAttrOut += `> _𝚅𝚎𝚕𝚘𝚌𝚒𝚍𝚊𝚍𝚎 𝙲𝚘𝚛𝚙𝚘𝚛𝚊𝚕:_ ${(totalBaseVcorp + VCORPAkumaMan).toLocaleString("pt-BR")}\n`;
        else {
            let vcorpNormStr = strCalc(
                VCORP,
                bonus.vcorp,
...
${manualAttrOut}${manualTecnicasOut}`;
    ...
    window.copyDataFichaPronta = out
        .replace(tecnicasOut, tecnicasOutCopy)
        .trim();

    let logOut =
        "*Log de Atualizações:*Iີີີີີີ່່່່່່້້້່ີີ່້ິູຸູິິິ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີ້ີ້ິ້ິີີີີີີ່່່່່່້້້່ີີ່້ິູຸູິິ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີ້ີ້ິ້ິີີີີີີ່່່່່່້້້່ີ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີີີີີີ່່່່່່້້້່ີີ່້ິູຸູິິິ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີ້ີ້ິ້ິີີີີີີ່່່່່່້້້່ີີ່້ິູຸູິິ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີ້ີ້ິ້ິີີີີີີ່່່່່່້້້່ີ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີີີີີີ່່່່່່້້້່ີີ່້ິູຸູິິິ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີ້ີ້ິ້ິີີີີີີ່່່່່່້້້່ີີ່້ິູຸູິິ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີ້ີ້ິ້ິີີີີີີ່່່່່່້້້່ີ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີີີີີີ່່່່່່້້້່ີີ່້ິູຸູິິິ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີ້ີ້ິ້ິີີີີີີ່່່່່່້້້່ີີ່້ິູຸູິິ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີ້ີ້ິ້ິີີີີີີ່່່່່່້້້່ີ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີີີີີີ່່່່່່້້້່ີີ່້ິູຸູິິິ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີ້ີ້ິ້ິີີີີີີ່່່່່່້້້່ີີ່້ິູຸູິິ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊໊ີ້ີ້ີ້ີ້ີ້ິ້ິີີີີີີ່່່່່່້້້່ີ໌ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້ິ້໌໌໌ີ້ຼຼຼຼຼຼຼຼຼຼຼຼ໋໋໋໋໋໋໋໊໊໊໊໊\n";
    if (currentChar.logList && currentChar.logList.length > 0) {
...
async function copyPartialLog() {
    if (
        !currentChar ||
        !currentChar.logList ||
        currentChar.logList.length === 0
    ) {
        await customAlert("Não há logs para copiar.");
        return;
    }
    let numToCopy = parseInt(
        document.getElementById("num-logs-copy").value,
        10,
    );
    if (isNaN(numToCopy) || numToCopy < 1) numToCopy = 1;
    if (numToCopy > currentChar.logList.length)
        numToCopy = currentChar.logList.length;
    ...
    await customAlert(
        numToCopy === 1
            ...
            : `As últimas ${numToCopy} entradas foram copiadas com sucesso!`,
    );
}
...
async function changeFichaID() {
    ...
    if (currentDocId === "") {
        await customAlert(
            "Você precisa carregar ou salvar uma ficha primeiro para poder mudar o ID dela.",
        );
        return;
    }
    if (isReadOnly) {
        await customAlert(
            "Você está no modo de leitura. Insira a senha da ficha atual para provar que é o dono e poder mudar o ID.",
        );
        return;
    }
    ...
    let novoId = await customPrompt(
        `O ID atual é "${currentDocId}". Digite o NOVO ID desejado (Exatamente 4 números):`,
    );
    if (!novoId || novoId.trim() === "" || novoId.trim() === currentDocId) {
        return;
    }
    novoId = novoId.trim().toUpperCase();
    if (!/^\d{4}$/.test(novoId) && novoId !== "NPCS" && novoId !== "NPCI") {
        await customAlert(
            "O NOVO ID deve conter EXATAMENTE 4 NÚMEROS (ex: 1234).",
        );
        return;
    }
    document.getElementById("db-status").classList.add("syncing");
    ...
    try {
        ...
        if (docRef.exists) {
            ...
            if (conf !== ADMIN_PASSWORD && conf !== "Ben10000") {
                document
                    ...
                    .classList.remove("syncing");
                if (conf !== null)
                    await customAlert("Senha incorreta! Operação cancelada.");
                return;
            }
        }
        ...
        const backupRefOld = db
            .collection("fichas_op")
            .doc("BACKUP-" + currentDocId);
...
async function saveBackup() {
    ...
    if (isReadOnly) {
        await customAlert(
            "Você está no modo de leitura. Insira a senha da ficha para criar um backup.",
        );
        return;
    }
    ...
    if (doc.exists) {
        ...
        if (data.backupPassword) {
            let pass = await customPrompt(
                "Digite a senha atual do backup para autorizar a substituição:",
            );
            if (
    ...
    let newPass = await customPrompt(
        "Digite a senha exclusiva de backup (deve ser diferente da senha principal):",
    );
    ...
    if (newPass === charData.password) {
        await customAlert(
            "A senha do backup DEVE ser diferente da senha normal da ficha.",
        );
        return;
    }
    document.getElementById("db-status").classList.add("syncing");
...
async function loadBackup() {
    if (!isFirebaseReady || !db || currentDocId === "") {
        await customAlert(
            "Carregue uma ficha com ID primeiro para puxar seu backup.",
        );
        return;
    }
    let backupRef = db.collection("fichas_op").doc("BACKUP-" + currentDocId);
    ...
    let conf = await customPrompt(
        "Isso irá SOBRESCREVER sua ficha atual com o backup. Digite 'SIM' para confirmar:",
    );
...
window.puxarVelocidade = async function () {
    ...
    if (ativo !== passivo && ativo > 0) {
        let resp = await customPrompt(
            `Este atributo possui um buff de item ativo. Deseja puxar a V. Corporal baseada no valor passivo (${val.toLocaleString("pt-BR")}) ou ativo (${Math.floor(ativo * proporcao).toLocaleString("pt-BR")})? Digite 1 para Passivo ou 2 para Ativo:`,
            true,
        );
        if (resp === "2") val = Math.floor(ativo * proporcao);
        else if (resp !== "1") return;
    }
    document.getElementById("info-estaminaVelocidade").value =
...
window.puxarDestrezaDano = async function () {
    ...
    if (ativo !== passivo) {
        let resp = await customPrompt(
            `Este atributo possui um buff de item ativo. Deseja puxar o valor passivo (${passivo.toLocaleString("pt-BR")}) ou ativo (${ativo.toLocaleString("pt-BR")})? Digite 1 para Passivo ou 2 para Ativo:`,
            true,
        );
        if (resp === "2") val = ativo;
        else if (resp !== "1") return;
    }
    document.getElementById("info-calcUseAttr").value =
        val.toLocaleString("pt-BR");
...
window.puxarResistenciaDano = async function () {
    ...
    document.getElementById("info-calcInimigoRes").value =
        val.toLocaleString("pt-BR");
...
window.sofrerDano = async function () {
    ...
    await customAlert(
        `Dano de ${dano.toLocaleString("pt-BR")} recebido! HP atualizado para: ${novoHp.toLocaleString("pt-BR")}`,
    );
};
...
window.puxarDano = function () {
    ...
    document.getElementById("info-estaminaDano").value =
        val.toLocaleString("pt-BR");
...
window.gastarEstamina = async function () {
    ...
    if (custo === 0) {
        await customAlert("O custo de Estamina é 0.");
        return;
    }
    ...
    updateUI();
    await customAlert(
        `Gasto de ${custo.toLocaleString("pt-BR")} Estamina aplicado! Estamina atual: ${novaEst.toLocaleString("pt-BR")}`,
    );
};
...
window.recuperarEstamina = async function (pct) {
    ...
    let estAtual = currentChar.info.estaminaAtual;
    if (estAtual >= total) {
        await customAlert("Estamina já está no máximo!");
        return;
    }
    ...
    let nomeRecovery = pct === 0.1 ? "Em Movimento" : "Repouso Total";
    await customAlert(
        `Recuperação (${nomeRecovery}): +${recup.toLocaleString("pt-BR")} Estamina! Estamina atual: ${novaEst.toLocaleString("pt-BR")}`,
    );
};
...
function iniciarMonitoramentoBancoDeDados() {
    ...
    let currentAkumaVal =
        currentChar && currentChar.info && currentChar.info.akumaNome
            ? currentChar.info.akumaNome
            : "nenhuma";
    let currentNacVal =
        currentChar && currentChar.info ? currentChar.info.nacionalidade : "";
    let currentLocVal =
        currentChar && currentChar.info ? currentChar.info.localizacao : "";
...
window.promoverCargo = async function () {
    ...
    if (nextRank === "Esquadrão") {
        let escolha = await customPrompt(
            "Escolha seu esquadrão (Digite exatamente: Combate, Operações, Inteligência ou Defesa):",
        );
        if (!escolha) return;
        escolha = escolha.trim().toLowerCase();
        let tipo = "";
        if (escolha === "combate") tipo = "Esquadrão de Combate";
        else if (escolha === "operações" || escolha === "operacoes")
            tipo = "Esquadrão de Operações";
        else if (escolha === "inteligência" || escolha === "inteligencia")
            tipo = "Esquadrão de Inteligência";
        ...
        let conf = await customPrompt(
            `Deseja aceitar a promoção para ${tipo}? Digite 'SIM' para confirmar:`,
        );
    ...
    if (nextRank === "Comandante Tático") {
        ...
        let tipoAtual = currentChar.info.patente
            .replace("Comandante Tático de ", "")
            .replace("Comandante Tática de ", "");
        nextRank = "Capitão Tático de " + tipoAtual;
    }

    let gKey = currentChar.info.sexo === "Feminino" ? "f" : "m";
    let dName = patenteGender[nextRank]
        ? patenteGender[nextRank][gKey]
        : nextRank;
    let conf = await customPrompt(
        `Deseja aceitar a promoção para ${dName}? Digite 'SIM' para confirmar:`,
    );
...
window.updateSexo = async function (val) {
    ...
    if (val === "Assexuado") {
        await customAlert(
            'Atenção: A escolha de "Assexuado" requer aprovação da ADM. Apenas seres bem específicos podem possuir essa característica fisiológica.',
        );
    }
...
window.rebaixarCargo = async function () {
    ...
    let gKey = currentChar.info.sexo === "Feminino" ? "f" : "m";
    let dName = patenteGender[prevRank]
        ? patenteGender[prevRank][gKey]
        : prevRank;

    let conf = await customPrompt(
        `Deseja realmente voltar para a patente ${dName}? Digite 'SIM' para confirmar:`,
    );
    ...
    if (modo === "tudo") {
        ...
        fileName =
            currentChar && currentChar.name
                ? currentChar.name.replace(/[^a-z0-9]/gi, "_").toLowerCase()
                : "personagem";
    }
...
window.importarJSON = function (event) {
    if (isReadOnly) {
        customAlert(
            "A ficha atual está em Modo Leitura. Desbloqueie-a ou carregue um ID em branco antes de importar.",
        );
        event.target.value = "";
        return;
    }
    ...
    reader.onload = async function (e) {
        try {
            ...
            let resp = await customPrompt(
                "Digite 1 para SUBSTITUIR TUDO, 2 para ADICIONAR COMO NOVO, ou 3 para SUBSTITUIR O ATUAL:",
                true,
            );
            ...
            if (resp === "1") {
                ...
                if (currentSaveMode !== undefined)
                    charData.saveMode = currentSaveMode;
                if (currentBackupPassword !== undefined)
                    charData.backupPassword = currentBackupPassword;
                ...
                if (isSingle) {
                    ...
                    if (incomingData.pcs) {
                        ...
                        await customAlert(
                            "O arquivo não possui formato válido para adicionar múltiplos personagens.",
                        );
                        event.target.value = "";
                        return;
                    }
                ...
                if (isSingle) {
                    ...
                    await customAlert(
                        "O arquivo possui múltiplos personagens. Só é possível substituir o atual usando um arquivo de personagem único.",
                    );
                    event.target.value = "";
                    return;
                }
            ...
            await customAlert(
                "Erro ao ler o arquivo JSON. Certifique-se de que é um arquivo válido.",
            );
        }
        event.target.value = "";
    };
